 ...
 *   https://datatables.net/download/#dt/dt-2.0.3/b-3.0.1/fh-4.0.1/r-3.0.1/sb-1.7.0/sl-2.0.0
 *
 * Included libraries:
 *  DataTables 2.0.3, Buttons 3.0.1, FixedHeader 4.0.1, Responsive 3.0.1, SearchBuilder 1.7.0, Select 2.0.0
 */
...
!function(n) {
    ...
    function o(e, t, n) {
        var a = typeof e
          , r = "string" == a;
        return "number" == a || "bigint" == a || !!y(e) || (t && r && (e = P(e, t)),
        n && r && (e = e.replace(j, "")),
    ...
    var C, U, t, e, $ = function(e, H) {
        var W, X, V;
        return $.factory(e, H) ? $ : this instanceof $ ? B(e).DataTable(H) : (X = void 0 === (H = e),
        V = (W = this).length,
        X && (H = {}),
        this.api = function() {
            return new U(this)
        ...
        this.each(function() {
            ...
            if ("table" != this.nodeName.toLowerCase())
                Z(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
            else {
                ...
                null !== e && "" !== e || (e = "DataTables_Table_" + $.ext._unique++,
                this.id = e);
                ...
                ne(n),
                n.aLengthMenu && !n.iDisplayLength && (n.iDisplayLength = Array.isArray(n.aLengthMenu[0]) ? n.aLengthMenu[0][0] : B.isPlainObject(n.aLengthMenu[0]) ? n.aLengthMenu[0].value : n.aLengthMenu[0]),
                n = Je(B.extend(!0, {}, t), n),
                Q(u.oFeatures, n, ["bPaginate", "bLengthChange", "bFilter", "bSort", "bSortMulti", "bInfo", "bProcessing", "bAutoWidth", "bSortClasses", "bServerSide", "bDeferRender"]),
                Q(u, n, ["ajax", "fnFormatNumber", "sServerMethod", "aaSorting", "aaSortingFixed", "aLengthMenu", "sPaginationType", "iStateDuration", "bSortCellsTop", "iTabIndex", "sDom", "fnStateLoadCallback", "fnStateSaveCallback", "renderer", "searchDelay", "rowId", "caption", "layout", ["iCookieDuration", "iStateDuration"], ["oSearch", "oPreviousSearch"], ["aoSearchCols", "aoPreSearchCols"], ["iDisplayLength", "_iDisplayLength"]]),
                Q(u.oScroll, n, [["sScrollX", "sX"], ["sScrollXInner", "sXInner"], ["sScrollY", "sY"], ["bScrollCollapse", "bCollapse"]]),
                ...
                u.oClasses)
                  , d = (B.extend(c, $.ext.classes, n.oClasses),
                o.addClass(c.table),
                u.oFeatures.bPaginate || (n.iDisplayStart = 0),
                void 0 === u.iInitDisplayStart && (u.iInitDisplayStart = n.iDisplayStart,
                u._iDisplayStart = n.iDisplayStart),
                u.oLanguage)
                  , f = (B.extend(!0, d, n.oLanguage),
                d.sUrl ? (B.ajax({
                    dataType: "json",
                    url: d.sUrl,
                    success: function(e) {
                    ...
                    error: function() {
                        Z(u, 0, "i18n file loading error", 21),
                        Oe(u)
                    }
                }),
                ...
                if (n.aoColumns)
                    ...
                    for (l = p[a = 0].length; a < l; a++)
                        f.push(null);
                for (a = 0,
                l = f.length; a < l; a++)
                    re(u);
                var g, m, v, b, y, D, x, S = u, T = n.aoColumnDefs, w = f, M = p, _ = function(e, t) {
                    oe(u, e, t)
                }, C = S.aoColumns;
                if (w)
                    for (g = 0,
                    ...
                    for (g = T.length - 1; 0 <= g; g--) {
                        ...
                        b = I.length; v < b; v++) {
                            ...
                            if ("number" == typeof A && 0 <= A) {
                                ...
                                for (y = 0,
                                D = C.length; y < D; y++)
                                    "_all" === A ? _(y, x) : -1 !== A.indexOf(":name") ? C[y].sName === A.replace(":name", "") && _(y, x) : M.forEach(function(e) {
                                        e[y] && (e = B(e[y].cell),
                                        A.match(/^[a-z][\w-]*$/i) && (A = "." + A),
                                        e.is(A)) && _(y, x)
                                    })
                ...
                if (w)
                    ...
                    m = w.length; g < m; g++)
                        _(g, w[g]);
                var F, L, N, j, P = o.children("tbody").find("tr").eq(0), R = (P.length && (F = function(e, t) {
                ...
                u.oFeatures), O = function() {
                    ...
                    var t = o.children("caption")
                      , t = (u.caption && (t = 0 === t.length ? B("<caption/>").appendTo(o) : t).html(u.caption),
                    t.length && (t[0]._captionSide = t.css("caption-side"),
                    u.captionNode = t[0]),
                    0 === h.length && (h = B("<thead/>").appendTo(o)),
                    u.nTHead = h[0],
                    B("tr", h).addClass(c.thead.row),
                    o.children("tbody"))
                      , t = (0 === t.length && (t = B("<tbody/>").insertAfter(h)),
                    u.nTBody = t[0],
                    o.children("tfoot"));
                    if (0 === t.length && (t = B("<tfoot/>").appendTo(o)),
                    u.nTFoot = t[0],
                    B("tr", t).addClass(c.tfoot.row),
                    n.aaData)
                        for (a = 0; a < n.aaData.length; a++)
                            Y(u, n.aaData[a]);
                    else
                        "dom" == te(u) && se(u, B(u.nTBody).children("tr"));
                    u.aiDisplay = u.aiDisplayMaster.slice(),
                    !(u.bInitialised = !0) === r && Oe(u)
                };
                K(u, "aoDrawCallback", Ye),
                n.bStateSave ? (R.bStateSave = !0,
                N = O,
                (L = u).oFeatures.bStateSave ? void 0 !== (j = L.fnStateLoadCallback.call(L.oInstance, L, function(e) {
                    Ge(L, e, N)
                })) && Ge(L, j, N) : N()) : O()
            }
        }),
        ...
        buttons: {},
        classes: {},
        builder: "dt/dt-2.0.3/b-3.0.1/fh-4.0.1/r-3.0.1/sb-1.7.0/sl-2.0.0",
        errMode: "alert",
        feature: [],
        features: {},
        search: [],
    ...
    {}), d = /[\r\n\u2028]/g, F = /<.*?>/g, L = /^\d{2,4}[./-]\d{1,2}[./-]\d{1,2}([T ]{1}\d{1,2}[:.]\d{2}([.:]\d{2})?)?$/, N = new RegExp("(\\" + ["/", ".", "*", "+", "?", "|", "(", ")", "[", "]", "{", "}", "\\", "$", "^", "-"].join("|\\") + ")","g"), j = /['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi, y = function(e) {
        return !e || !0 === e || "-" === e
    }, P = function(e, t) {
        return c[t] || (c[t] = new RegExp(je(t),"g")),
        "string" == typeof e && "." !== t ? e.replace(/\./g, "").replace(c[t], ".") : e
    }, f = function(e, t, n) {
        var a = []
          , r = 0
          , o = e.length;
    ...
    $.util = {
        ...
        set: function(a) {
            var f;
            return B.isPlainObject(a) ? $.util.set(a._) : null === a ? function() {}
    ...
    function oe(e, t, n) {
        ...
        r._bAttrSrc = B.isPlainObject(o) && (a(o.sort) || a(o.type) || a(o.filter)),
        r._setter = null,
    ...
    function E(e) {
        ...
        if (t.oFeatures.bAutoWidth) {
            var n, a, r = t.nTable, o = t.aoColumns, i = t.oScroll, l = i.sY, s = i.sX, i = i.sXInner, u = W(t, "bVisible"), c = r.getAttribute("width"), d = r.parentNode, f = r.style.width, f = (f && -1 !== f.indexOf("%") && (c = f),
            ee(t, null, "column-calc", {
                visible: u
            }, !1),
            B(r.cloneNode()).css("visibility", "hidden").removeAttr("id")), h = (f.append("<tbody>"),
            B("<tr/>").appendTo(f.find("tbody")));
            for (f.append(B(t.nTHead).clone()).append(B(t.nTFoot).clone()),
            f.find("tfoot th, tfoot td").css("width", ""),
            f.find("thead th, thead td").each(function() {
                var e = ie(t, this, !0, !1);
                e ? (this.style.width = e,
                s && B(this).append(B("<div/>").css({
                    width: e,
                    margin: 0,
                    padding: 0,
                    border: 0,
            ...
            v.remove(),
            c && (r.style.width = A(c)),
            !c && !s || t._reszEvt || (B(q).on("resize.DT-" + t.sInstance, $.util.throttle(function() {
                t.bDestroying || E(t)
            })),
            t._reszEvt = !0)
        }
        ...
        for (var t, n, a, r, o, i, l, s = e.aoColumns, u = e.aoData, c = $.ext.type.detect, d = 0, f = s.length; d < f; d++) {
            ...
            !(o = s[d]).sType && o._sManualType)
                ...
                n = c.length; t < n; t++) {
                    ...
                    r = u.length; a < r; a++)
                        if (u[a]) {
                            if (void 0 === l[a] && (l[a] = G(e, a, d, "type")),
    ...
    function G(e, t, n, a) {
        ...
        if (void 0 === (s = "display" !== a && s && "object" == typeof s && s.nodeName ? s.innerHTML : s))
            return e.iDrawError != r && null === l && (Z(e, 0, "Requested unknown parameter " + ("function" == typeof o.mData ? "{function}" : "'" + o.mData + "'") + " for row " + t + ", column " + n, 4),
            e.iDrawError = r),
            l;
    ...
    function pe(e, t, n, a) {
        ...
        "dom" !== n && (n && "auto" !== n || "dom" !== i.src)) {
            ...
            i._aData = ge(e, i, a, void 0 === a ? void 0 : i._aData).data;
        var u = e.aoColumns;
        if (void 0 !== a)
            u[a].sType = null,
    ...
    function ge(e, t, n, a) {
        function r(e, t) {
            ...
            m(e)(a, t.getAttribute(n)))
        }
        function o(e) {
            void 0 !== n && n !== d || (l = f[d],
            s = e.innerHTML.trim(),
            l && l._bAttrSrc ? (m(l.mData._)(a, s),
            r(l.mData.sort, e),
            r(l.mData.type, e),
            r(l.mData.filter, e)) : h ? (l._setter || (l._setter = m(l.mData)),
            l._setter(a, s)) : a[d] = s),
            d++
        }
    ...
    function ve(e, t, n, a) {
        ...
        if (null === c.nTr) {
            ...
            s = e.aoColumns.length; l < s; l++) {
                i = e.aoColumns[l],
                (o = (u = !n || !a[l]) ? _.createElement(i.sCellType) : a[l]) || Z(e, 0, "Incorrect column count", 18),
                o._DT_CellIndex = {
                    row: t,
                    column: l
                },
                f.push(o);
                var p = me(e, t);
                !u && (!i.mRender && i.mData === l || B.isPlainObject(i.mData) && i.mData._ === l + ".display") || ue(o, p[l]),
                i.bVisible && u ? r.appendChild(o) : i.bVisible || u || o.parentNode.removeChild(o),
                i.fnCreatedCell && i.fnCreatedCell.call(e.oInstance, o, G(e, t, l), d, t, l)
            }
    ...
    function be(e, t) {
        ...
        a.DT_RowData) && B(n).data(a.DT_RowData)
    }
    function ye(e, t) {
        ...
        if (o) {
            if (("header" === t || f(e.aoColumns, i).join("")) && 1 === (n = (n = B("tr", o)).length ? n : B("<tr/>").appendTo(o)).length)
                for (var l = B("td, th", n).length, s = r.length; l < s; l++)
                    B("<th/>").html(r[l][i] || "").appendTo(n);
            var u = Ce(e, o, !0);
            "header" === t ? e.aoHeader = u : e.aoFooter = u,
            B(o).children("tr").attr("role", "row"),
            B(o).children("tr").children("th, td").each(function() {
                Ke(e, t)(e, B(this), a)
            })
        }
    }
    ...
    function S(e, t) {
        ...
        -1 !== ee(e, "aoPreDrawCallback", "preDraw", [e]).indexOf(!1))
            ...
            var l, n = [], a = 0, r = "ssp" == te(e), o = e.aiDisplay, i = e._iDisplayStart, s = e.fnDisplayEnd(), u = e.aoColumns, c = B(e.nTBody);
            if (e.bDrawing = !0,
            r) {
                if (!e.bDestroying && !t)
                    return 0 === e.iDraw && c.empty().append(Se(e)),
                    (l = e).iDraw++,
                    w(l, !0),
                    void Ie(l, function(t) {
                        function n(e, t) {
            ...
            if (0 !== o.length)
                for (var d = r ? e.aoData.length : s, f = r ? 0 : i; f < d; f++) {
                    for (var h = o[f], p = e.aoData[h], g = (null === p.nTr && ve(e, h),
                    p.nTr), m = 0; m < u.length; m++) {
                        var v = u[m]
                          , b = p.anCells[m];
                    ...
                    ee(e, "aoRowCallback", null, [g, p._aData, a, f, h]),
                    n.push(g),
                    a++
                }
            else
                n[0] = Se(e);
            ee(e, "aoHeaderCallback", "header", [B(e.nTHead).children("tr")[0], fe(e), i, s, o]),
            ee(e, "aoFooterCallback", "footer", [B(e.nTFoot).children("tr")[0], fe(e), i, s, o]),
            c[0].replaceChildren ? c[0].replaceChildren.apply(c[0], n) : (c.children().detach(),
            c.append(B(n))),
            B(e.nTableWrapper).toggleClass("dt-empty-footer", 0 === B("tr", e.nTFoot).length),
    ...
    function Te(e, t, n) {
        ...
        []), o = 0, l = a.length; o < l; o++)
            ...
            we(e, r[r.length - 1]),
            delete a[o].val.full),
            Object.keys(a[o].val).length && (r.push(a[o].val),
            we(e, r[r.length - 1]));
        return r
    }
    function we(o, i) {
        function l(e, t) {
            return C.features[e] || Z(o, 0, "Unknown feature: " + e),
            C.features[e].apply(this, [o, t])
        }
        B.each(i, function(e) {
            for (var t, n = i[e].contents, a = 0, r = n.length; a < r; a++)
                n[a] && ("string" == typeof n[a] ? n[a] = l(n[a], null) : B.isPlainObject(n[a]) ? n[a] = l(n[a].feature, n[a].opts) : "function" == typeof n[a].node ? n[a] = n[a].node(o) : "function" == typeof n[a] && (t = n[a](o),
                n[a] = "function" == typeof t.node ? t.node() : t))
        })
    }
    function _e(t) {
        var a, e = t.oClasses, n = B(t.nTable), r = B("<div/>").attr({
        ...
        t.sDom)
            for (var o, i, l, s, u, c, d = t, e = t.sDom, f = r, h = e.match(/(".*?")|('.*?')|./g), p = 0; p < h.length; p++)
                ...
                p++),
                f.append(l),
                f = l) : ">" == i ? f = f.parent() : "t" == i ? o = He(d) : $.ext.feature.forEach(function(e) {
        ...
        n.oFeatures.bProcessing && (a = B("<div/>", {
            ...
            role: "status"
        }).html(n.oLanguage.sProcessing).append("<div><div></div><div></div><div></div><div></div></div>").insertBefore(e),
        B(e).on("processing.dt.DT", function(e, t, n) {
            a.css("display", n ? "block" : "none")
        }))
    }
    function Ce(e, t, n) {
        for (var a, r, o, i, l, s, u = e.aoColumns, c = B(t).children("tr"), d = t && "thead" === t.nodeName.toLowerCase(), f = [], h = 0, p = c.length; h < p; h++)
            f.push([]);
        for (h = 0,
        p = c.length; h < p; h++)
            for (r = (a = c[h]).firstChild; r; ) {
                if ("TD" == r.nodeName.toUpperCase() || "TH" == r.nodeName.toUpperCase()) {
                    ...
                    (v = r.style.width.match(/width:\s*(\d+[pxem%]+)/)) && (m = v[1]),
                    g.sWidthOrig = g.sWidth || m,
                    d ? (null === g.sTitle || g.autoTitle || (r.innerHTML = g.sTitle),
                    !g.sTitle && s && (g.sTitle = r.innerHTML.replace(/<.*?>/g, ""),
                    g.autoTitle = !0)) : g.footer && (r.innerHTML = g.footer),
                    g.ariaTitle || (g.ariaTitle = B(r).attr("aria-label") || g.sTitle),
                    g.className) && B(r).addClass(g.className),
                    0 === B("span.dt-column-title", r).length && B("<span>").addClass("dt-column-title").append(r.childNodes).appendTo(r),
                    d) && 0 === B("span.dt-column-order", r).length && B("<span>").addClass("dt-column-order").appendTo(r),
                    i = 0; i < b; i++) {
                        for (o = 0; o < y; o++)
                            f[h + o][l + i] = {
                                cell: r,
    ...
    function Ie(n, e, a) {
        ...
        var r, o = n.ajax, i = n.oInstance, l = (B.isPlainObject(o) && o.data && (l = "function" == typeof (r = o.data) ? r(e, n) : r,
        ...
        delete o.data),
        {
            ...
            error: function(e, t) {
                -1 === ee(n, null, "xhr", [n, null, n.jqXHR], !0).indexOf(!0) && ("parsererror" == t ? Z(n, 0, "Invalid JSON response", 1) : 4 === e.readyState && Z(n, 0, "Ajax error", 7)),
                w(n, !1)
            }
        });
        ...
        $.util.set(o.dataSrc)(i, []),
        t(i)) : (n.jqXHR = B.ajax(l),
        r && (o.data = r))
    }
    function Ae(e, t, n) {
        var a = "data";
        if (B.isPlainObject(e.ajax) && void 0 !== e.ajax.dataSrc && ("string" == typeof (e = e.ajax.dataSrc) || "function" == typeof e ? a = e : void 0 !== e.data && (a = e.data)),
        !n)
        ...
        "ssp" != te(n)) {
            for (var a, r, o, i, l, s = n, u = s.aoColumns, c = s.aoData, d = 0; d < c.length; d++)
                if (c[d] && !(l = c[d])._aFilterData) {
                    ...
                    a = 0,
                    r = u.length; a < r; a++)
                        u[a].bSearchable ? "string" != typeof (i = null === (i = G(s, d, a, "filter")) ? "" : i) && i.toString && (i = i.toString()) : i = "",
                        i.indexOf && -1 !== i.indexOf("&") && (Pe.innerHTML = i,
                        i = Re ? Pe.textContent : Pe.innerText),
    ...
    function Ne(e, t, n, a, r) {
        if ("" !== n)
            for (var o = 0, i = "function" == typeof n ? n : null, l = n instanceof RegExp ? n : i ? null : function(e, t) {
                ...
                if (e = R(e),
                t.exact)
                    return new RegExp("^" + je(e) + "$",t.caseInsensitive ? "i" : "");
                {
                    var n, r, o;
                    e = t.regex ? e : je(e),
                ...
                (i && !i(u, s._aData, e[o], r) || l && !l.test(u)) && (e.splice(o, 1),
                o--),
                o++
            }
    }
    ...
    function Oe(n) {
        ...
        Ve(e, t, t === e.nTHead ? "tr" + o + " th" + o + ", tr" + o + " td" + o : "th" + o + ", td" + o),
        qe(e, r = [], e.aaSorting),
        e.aaSorting = r,
        Xe(n),
        w(n, !0),
        ...
        s(n),
        "ssp" != (i = te(n)) && ("ajax" == i ? Ie(n, {}, function(e) {
            var t = Ae(n, e);
    ...
    function He(e) {
        var t, n, a, r, o, i, l, s, u, c, d, f, h, p = B(e.nTable), g = e.oScroll;
    ...
    function We(e) {
        var t, n, a = e.oScroll.iBarWidth, r = B(e.nScrollHead).children("div"), o = r.children("table"), i = e.nScrollBody, l = B(i), s = B(e.nScrollFoot).children("div"), u = s.children("table"), c = B(e.nTHead), d = B(e.nTable), f = e.nTFoot && B("th, td", e.nTFoot).length ? B(e.nTFoot) : null, h = e.oBrowser, p = i.scrollHeight > i.clientHeight;
        e.scrollBarVis !== p && void 0 !== e.scrollBarVis ? (e.scrollBarVis = p,
        E(e)) : (e.scrollBarVis = p,
        ...
        e.aiDisplay.length && (t = d.find("tbody tr").eq(0).find("th, td").map(function() {
        ...
        f && (u.find("colgroup").remove(),
        u.append(e.colgroup.clone())),
        ...
        c = Math.floor(d.height()) > i.clientHeight || "scroll" == l.css("overflow-y"),
            ...
            if (n.length) {
                for (var a = 0, r = n.length; a < r; a++)
                    if (!1 !== function(e, t, n, a) {
                        ...
                        (a || n) && e.oFeatures.bSortMulti ? -1 !== (i = f(l, "0").indexOf(t)) ? null === (o = null === (o = r(l[i], !0)) && 1 === l.length ? 0 : o) ? l.splice(i, 1) : (l[i][1] = s[o],
    ...
    function Ue(e) {
        var t, n, a, r, o, i, l, s = [], u = $.ext.type.order, c = e.aoColumns, d = e.aaSortingFixed, f = B.isPlainObject(d), h = [];
        if (e.oFeatures.bSort)
            for (Array.isArray(d) && qe(e, h, d),
    ...
    function $e(e, t, n) {
        var a, r, o, i, l, c, d = [], s = $.ext.type.order, f = e.aoData, u = e.aiDisplayMaster;
        for (X(e),
        void 0 !== t ? (l = e.aoColumns[t],
        c = [{
            src: t,
            col: t,
            dir: n,
        ...
        r = c.length; a < r; a++) {
            i = c[a],
            S = x = D = g = p = h = y = b = v = m = void 0;
            var h, p, g, m = e, v = i.col, b = m.aoColumns[v], y = $.ext.order[b.sSortDataType];
            y && (h = y.call(m.oInstance, m, v, T(m, v)));
            for (var D = $.ext.type.order[b.sType + "-pre"], x = m.aoData, S = 0; S < x.length; S++)
                x[S] && ((p = x[S])._aSortData || (p._aSortData = []),
                p._aSortData[v] && !y || (g = y ? h[S] : G(m, S, v, "sort"),
    ...
    function ze(e) {
        var t, n, a, r = e.aLastSort, o = e.oClasses.order.position, i = Ue(e), l = e.oFeatures;
    ...
    function Ge(n, e, t) {
        ...
        n._bInitComplete ? new $.Api(n) : null);
        if (e && e.time) {
            var l = n.iStateDuration;
            if (0 < l && e.time < +new Date - 1e3 * l)
                n._bLoadingState = !1;
            else if (-1 !== ee(n, "aoStateLoadParams", "stateLoadParams", [n, e]).indexOf(!1))
                n._bLoadingState = !1;
            else if (e.columns && o.length !== e.columns.length)
                n._bLoadingState = !1;
            else {
                if (n.oLoadedState = B.extend(!0, {}, e),
                ...
                n.iInitDisplayStart = e.start) : Me(n, e.start / n._iDisplayLength)),
                ...
                n._bLoadingState = !1,
                ee(n, "aoStateLoaded", "stateLoaded", [n, e])
            }
        } else
            n._bLoadingState = !1;
        t()
    ...
    function Z(e, t, n, a) {
        ...
        t)
            ...
            if (e && ee(e, null, "dt-error", [e, a, n], !0),
            "alert" == t)
                alert(n);
            else {
                if ("throw" == t)
    ...
    function Je(e, t, n) {
        ...
        for (r in t)
            ...
            B.isPlainObject(a) ? (B.isPlainObject(e[r]) || (e[r] = {}),
            B.extend(!0, e[r], a)) : n && "data" !== r && "aaData" !== r && Array.isArray(a) ? e[r] = a.slice() : e[r] = a);
        return e
    }
    function Ze(e, t, n) {
    ...
    U = function(e, t) {
        ...
        function n(e) {
            ...
            t = $.settings,
            a = f(t, "nTable");
            var n, t, a, r = e ? e.nTable && e.oFeatures ? [e] : e.nodeName && "table" === e.nodeName.toLowerCase() ? -1 !== (r = a.indexOf(e)) ? [t[r]] : null : e && "function" == typeof e.settings ? e.settings().toArray() : ("string" == typeof e ? n = B(e).get() : e instanceof B && (n = e.get()),
    ...
    B.extend(U.prototype, {
        ...
        iterator: function(e, t, n, a) {
            ...
            return f.length || a ? ((e = (a = new U(h,e ? f.concat.apply([], f) : f)).selector).rows = p.rows,
            e.cols = p.cols,
            e.opts = p.opts,
            a) : this
        },
    ...
    U.extend = function(e, t, n) {
        if (n.length && t && (t instanceof U || t.__dt_wrapper))
            for (var a, r = 0, o = n.length; r < o; r++)
                t[(a = n[r]).name] = "function" === a.type ? function(t, n, a) {
                    return function() {
                        var e = n.apply(t || this, arguments);
                        return U.extend(e, e, a.methodExt),
                        e
                    }
    ...
    U.register = t = function(e, t) {
        if (Array.isArray(e))
            ...
            for (var r = e.split("."), o = tt, i = 0, l = r.length; i < l; i++) {
                ...
                i === l - 1 ? (c.val = t,
                c.type = "function" == typeof t ? "function" : B.isPlainObject(t) ? "object" : "other") : o = s ? c.methodExt : c.propExt
            }
    }
    ,
    ...
    function at(r, o, e) {
        ...
        "ssp" == te(r) ? s(r, o) : (w(r, !0),
        (n = r.jqXHR) && 4 !== n.readyState && n.abort(),
        Ie(r, {}, function(e) {
            he(r);
            for (var t = Ae(r, e), n = 0, a = t.length; n < a; n++)
                Y(r, t[n]);
            s(r, o),
            ke(r),
            w(r, !1)
    ...
    t("ajax.url()", function(t) {
        ...
        B.isPlainObject(e.ajax) ? e.ajax.url : e.ajax) : this.iterator("table", function(e) {
    ...
    function lt(o, i, e, t) {
        function l(e, t) {
            ...
            if (Array.isArray(e) || e instanceof B)
                ...
                s.push(e)) : (n = B("<tr><td></td></tr>").attr("data-dt-row", i.idx).addClass(t),
    ...
    function st(e, t) {
        ...
        if (n.length && e.length) {
            ...
            if (a._details) {
                ...
                B(a.nTr).addClass("dt-hasChild")) : (a._details.detach(),
                B(a.nTr).removeClass("dt-hasChild")),
    ...
    function ct(t, n) {
        return function(e) {
            return y(e) || "string" != typeof e || (e = e.replace(d, " "),
            t && (e = I(e)),
            n && (e = R(e, !1))),
            e
        }
    ...
    var dt = function(e, t) {
      ...
      , ft = (t("rows()", function(n, a) {
        void 0 === n ? n = "" : B.isPlainObject(n) && (a = n,
        n = ""),
        a = ot(a);
        var e = this.iterator("table", function(e) {
            return t = rt("row", t = n, function(n) {
                ...
                if (n.nodeName)
                    ...
                    t = n._DT_CellIndex,
                    void 0 !== e ? a[e] && a[e].nTr === n ? [e] : [] : t ? a[t.row] && a[t.row].nTr === n.parentNode ? [t.row] : [] : (e = B(n).closest("*[data-dt-row]")).length ? [e.data("dt-row")] : [];
    ...
    t("rows.add()", function(o) {
        var e = this.iterator("table", function(e) {
            for (var t, n = [], a = 0, r = o.length; a < r; a++)
                (t = o[a]).nodeName && "TR" === t.nodeName.toUpperCase() ? n.push(se(e, t)[0]) : n.push(Y(e, t));
            return n
        }, 1)
          , t = this.rows(-1);
        return t.pop(),
    ...
    function(e, t) {
      ...
      , vt = (t(mt, function(e, t) {
        var n = this.context;
        return void 0 === e ? n.length && this.length && n[0].aoData[this[0]] ? n[0].aoData[this[0]]._details : void 0 : (!0 === e ? this.child.show() : !1 === e ? pt(this) : n.length && this.length && lt(n[0], n[0].aoData[this[0]], e, t),
        this)
    }),
    ...
    e("columns().visible()", "column().visible()", function(n, a) {
          ...
          , e = this.iterator("column", function(e, t) {
            ...
            !function(e, t, n) {
                ...
                if (i.bVisible === n)
                    return !1;
                if (n)
                    for (var s = f(o, "bVisible").indexOf(!0, t + 1), u = 0, c = l.length; u < c; u++)
                        l[u] && (r = l[u].nTr,
                        a = l[u].anCells,
                        r) && r.insertBefore(a[t], a[s] || null);
                else
                    B(f(e.aoData, "anCells", t)).detach();
                return i.bVisible = n,
                Xe(e),
                !0
            }(e, t, n) || r.push(t)
        ...
        return void 0 !== n && this.iterator("table", function(e) {
            xe(e, e.aoHeader),
            xe(e, e.aoFooter),
            e.aiDisplay.length || B(e.nTBody).find("td[colspan]").attr("colspan", H(e)),
            Ye(e),
    ...
    t("column.index()", function(e, t) {
        ...
        if (0 !== this.context.length)
            ...
            "fromVisible" === e || "toData" === e ? M(n, t) : "fromData" === e || "toVisible" === e ? T(n, t) : void 0
    }),
    ...
    t("cells()", function(g, e, m) {
        var a, r, o, i, l, s, t;
        return B.isPlainObject(g) && (void 0 === g.row ? (m = g,
        g = null) : (m = e,
        e = null)),
        B.isPlainObject(e) && (m = e,
        e = null),
                ...
                if (null == e || n) {
                    ...
                    l = f.length; i < l; i++)
                        ...
                        s = 0; s < p; s++)
                            ...
                            (!n || (c = d[r],
                            e(u, G(a, r, s), c.anCells ? c.anCells[s] : null))) && o.push(u);
                    return o
                }
    ...
    t("cell().data()", function(e) {
        ...
        return void 0 === e ? i.length && l.length ? G(i[0], l[0].row, l[0].column) : void 0 : (t = i[0],
        n = l[0].row,
        a = l[0].column,
        r = t.aoColumns[a],
        o = t.aoData[n]._aData,
    ...
    $.factory = function(e, t) {
        var n = !1;
        return e && e.document && (_ = (q = e).document),
        t && t.fn && t.fn.jquery && (B = t,
        n = !0),
        n
    }
    ,
    ...
    $.tables = function(t) {
        var e = !1
          , n = (B.isPlainObject(t) && (e = t.api,
        t = t.visible),
        $.settings.filter(function(e) {
    ...
    t("destroy()", function(c) {
        ...
        this.iterator("table", function(e) {
            ...
            e.aaSortingFixed = [],
            ze(e),
            B("th, td", r).removeClass(u.canAsc + " " + u.canDesc + " " + u.isAsc + " " + u.isDesc).css("width", ""),
            a.children().detach(),
            a.append(s),
    ...
    function xt(e, t, n) {
        var a;
        if (q.moment) {
            if (!(a = q.moment.utc(e, t, n, !0)).isValid())
                return null
        } else if (q.luxon) {
            if (!(a = t && "string" == typeof e ? q.luxon.DateTime.fromFormat(e, t) : q.luxon.DateTime.fromISO(e)).isValid)
                return null;
            a.setLocale(n)
        } else
            t ? (Dt || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"),
            Dt = !0) : a = new Date(e);
        return a
    }
    function St(s) {
        return function(a, r, o, i) {
            ...
            function(e, t) {
                ...
                "type" === t ? l : "" === e ? "sort" !== t ? "" : xt("0000-01-01 00:00:00", null, o) : !(null === r || a !== r || "sort" === t || "type" === t || e instanceof Date) || null === (n = xt(e, a, o)) ? e : "sort" === t ? n : (e = null === r ? yt(n, "toDate", "toJSDate", "")[s]() : yt(n, "format", "toFormat", "toISOString", r),
                "display" === t ? u(e) : e)
            }
        }
    }
    ...
    if (void 0 !== q.Intl)
        try {
            for (var _t = (new Intl.NumberFormat).formatToParts(100000.1), a = 0; a < _t.length; a++)
                "group" === _t[a].type ? Tt = _t[a].value : "decimal" === _t[a].type && (wt = _t[a].value)
        } catch (e) {}
    $.datetime = function(n, a) {
        var r = "datetime-detect-" + bt(n);
        a = a || "en",
        $.ext.type.order[r] || $.type(r, {
            detect: function(e) {
                var t = xt(e, n, a);
                return !("" !== e && !t) && r
            },
    ...
    var i = $.ext.type
      , Ct = ($.type = function(a, e, t) {
        ...
        void 0 === t && (t = e,
        e = null),
        "className" === e ? n("className", t) : "detect" === e ? r(t) : "order" === e ? o(t) : "render" === e ? n("render", t) : "search" === e ? n("search", t) : e || (t.className && n("className", t.className),
    ...
    function(e, t, n, a) {
        var r;
        return 0 === e || e && "-" !== e ? "number" == (r = typeof e) || "bigint" == r ? e : +(e = (e = t ? P(e, t) : e).replace && (n && (e = e.replace(n, "")),
        a) ? e.replace(a, "") : e) : -1 / 0
    }
    );
    B.extend(!0, $.ext.renderer, {
        ...
        header: {
            _: function(d, f, h) {
                ...
                "disable" === f.attr("data-dt-order") || "disable" === f.parent().attr("data-dt-order") || !0 === e && 0 !== n || !1 === e && n !== t.length - 1 || B(d.nTable).on("order.dt.DT", function(e, t, n) {
                    ...
                    f.removeClass(a.isAsc + " " + a.isDesc).toggleClass(a.none, !o).toggleClass(a.canAsc, o && l.includes("asc")).toggleClass(a.canDesc, o && l.includes("desc")),
                    -1 !== (l = s.indexOf("," + u.toArray().join(",") + ",")) && (s = c.order(),
                    f.addClass(s.includes("asc") ? a.isAsc : "" + s.includes("desc") ? a.isDesc : "")),
                    0 === l ? (u = n[0],
                    c = r.asSorting,
                    f.attr("aria-sort", "asc" === u.dir ? "ascending" : "descending"),
                    i = c[u.index + 1] ? "Reverse" : "Remove") : f.removeAttr("aria-sort"),
                    f.attr("aria-label", o ? r.ariaTitle + t.api.i18n("oAria.orderable" + i) : r.ariaTitle),
                    o) && (f.find(".dt-column-title").attr("role", "button"),
                    f.attr("tabindex", 0))
                })
            }
        },
    ...
    function Ft(e, t, n) {
        var a = []
          , r = Math.floor(n / 2);
        return t <= n ? a = h(0, t) : 1 === n ? a = [e] : 3 === n ? e <= 1 ? a = [0, 1, "ellipsis"] : t - 2 <= e ? (a = h(t - 2, t)).unshift("ellipsis") : a = ["ellipsis", e, "ellipsis"] : e <= r ? (a = h(0, n - 2)).push("ellipsis", t - 1) : (t - 1 - r <= e ? a = h(t - (n - 2), t) : ((a = h(e - r + 2, e + r - 1)).push("ellipsis", t - 1),
        a)).unshift(0, "ellipsis"),
        a
    }
    $.feature.register("search", function(n, e) {
        var t, a, r, o, i, l, s, u, c, d;
        return n.oFeatures.bFilter ? (t = n.oClasses.search,
        a = n.sTableId,
        c = n.oLanguage,
        r = n.oPreviousSearch,
        ...
        -1 === (e = B.extend({
            ...
            text: c.sSearch
        }, e)).text.indexOf("_INPUT_") && (e.text += "_INPUT_"),
        e.text = et(n, e.text),
        ...
        (s = B("<div>").addClass(t.container).append(l.replace(/_INPUT_/, o))).find("label").attr("for", "dt-search-" + It),
        s.find("input").attr("id", "dt-search-" + It),
        It++,
        u = function(e) {
            var t = this.value;
            r.return && "Enter" !== e.key || t != r.search && (r.search = t,
            Le(n, r),
            n._iDisplayStart = 0,
            S(n))
        }
        ...
        d = B("input", s).val(r.search).attr("placeholder", e.placeholder).on("keyup.DT search.DT input.DT paste.DT cut.DT", c ? $.util.debounce(u, c) : u).on("mouseup.DT", function(e) {
            setTimeout(function() {
                u.call(d[0], e)
            }, 10)
    ...
    $.feature.register("paging", function(e, t) {
        ...
        B(e.nTable).on("column-sizing.dt.DT", n),
        a
    }, "p");
    var Lt = 0;
    return $.feature.register("pageLength", function(a, e) {
        ...
        if (Array.isArray(r[0]))
            ...
            for (p = 0; p < r.length; p++)
                B.isPlainObject(r[p]) ? (o.push(r[p].value),
                i.push(r[p].label)) : (o.push(r[p]),
                i.push(r[p]));
        for (var l = e.text.match(/_MENU_$/), s = e.text.match(/^_MENU_/), u = e.text.replace(/_MENU_/, ""), e = "<label>" + e.text + "</label>", c = (s ? e = "_MENU_<label>" + u + "</label>" : l && (e = "<label>" + u + "</label>_MENU_"),
        B("<div/>").addClass(t.container).append(e.replace("_MENU_", "<span></span>"))), d = [], f = (c.find("label")[0].childNodes.forEach(function(e) {
        ...
        return c.find("label").attr("for", "dt-length-" + Lt),
        h.attr("id", "dt-length-" + Lt),
        Lt++,
        c.find("span").replaceWith(h),
        B("select", c).val(a._iDisplayLength).on("change.DT", function() {
            Ee(a, B(this).val()),
            S(a)
        }),
        B(a.nTable).on("length.dt.DT", function(e, t, n) {
            a === t && (B("select", c).val(n),
            f(n))
        }),
        f(a._iDisplayLength),
        c
...
!function(t) {
    ...
    }) : "object" == typeof exports ? (o = require("jquery"),
    d = function(e, n) {
    ...
    : (d(window, o),
    module.exports = t(o, window, window.document))) : t(jQuery, window, document)
}(function(e, n, t) {
    "use strict";
...
!function(e) {
    ...
    : (i(window, o),
    module.exports = e(o, window, window.document))) : e(jQuery, window, document)
}(function(x, g, m) {
    "use strict";
    var e = x.fn.dataTable
      ...
      , i = null;
    function v(t, n, e) {
        x.fn.animate ? t.stop().fadeIn(n, e) : (t.css("display", "block"),
        e && e.call(t))
    }
    function y(t, n, e) {
        x.fn.animate ? t.stop().fadeOut(n, e) : (t.css("display", "none"),
        e && e.call(t))
    }
    function _(n, t) {
        if (!e.versionCheck("2"))
    ...
    x.extend(_.prototype, {
        action: function(t, n) {
            ...
            return void 0 === n ? t.conf.action : (t.conf.action = n,
            this)
        },
        active: function(t, n) {
            var t = this._nodeToButton(t)
              ...
              , o = x(t.node);
            return t.inCollection && this.c.dom.collection.button && void 0 !== this.c.dom.collection.button.active && (e = this.c.dom.collection.button.active),
            void 0 === n ? o.hasClass(e) : (o.toggleClass(e, void 0 === n || n),
            this)
        },
        add: function(t, n, e) {
            ...
            return this._expandButton(o, t, void 0 !== t ? t.split : void 0, (void 0 === t || void 0 === t.split || 0 === t.split.length) && void 0 !== s, !1, n),
        ...
        collectionRebuild: function(t, n) {
            ...
            if (void 0 !== n) {
                ...
                for (e.conf.prefixButtons && n.unshift.apply(n, e.conf.prefixButtons),
        ...
        disable: function(t) {
            t = this._nodeToButton(t);
            return x(t.node).addClass(this.c.dom.button.disabled).prop("disabled", !0),
            this
        },
        destroy: function() {
        ...
        enable: function(t, n) {
            ...
            x(n.node).removeClass(this.c.dom.button.disabled).prop("disabled", !1),
            this)
        },
        ...
        node: function(t) {
            ...
            x(t.node)) : this.dom.container
        },
        processing: function(t, n) {
            var e = this.s.dt
              , o = this._nodeToButton(t);
            return void 0 === n ? x(o.node).hasClass("processing") : (x(o.node).toggleClass("processing", n),
            x(e.table().node()).triggerHandler("buttons-processing.dt", [n, e.button(t), e, x(t), o.conf]),
            this)
        },
        remove: function(t) {
        ...
        text: function(t, n) {
            ...
            var o = this._nodeToButton(t)
              ...
              , i = this.s.dt
              , s = x(o.node);
            return void 0 === n ? e(o.conf.text) : (o.conf.text = n,
            t.html(e(n)),
            this)
        },
        _constructor: function() {
            ...
            x("body").on("keyup." + this.s.namespace, function(t) {
                var n;
                m.activeElement && m.activeElement !== m.body || (n = String.fromCharCode(t.keyCode).toLowerCase(),
        ...
        _expandButton: function(t, n, e, o, i, s, r) {
            for (var a, l = this.s.dt, c = this.c.dom.collection, u = Array.isArray(n) ? n : [n], d = 0, f = (u = void 0 === n ? Array.isArray(e) ? e : [e] : u).length; d < f; d++) {
                ...
                if (p)
                    if (a = !(!p.config || !p.config.split),
                    Array.isArray(p))
                        this._expandButton(t, p, void 0 !== h && void 0 !== h.conf ? h.conf.split : void 0, o, void 0 !== r && void 0 !== r.split, s, r);
                    else {
                        var h = this._buildButton(p, o, void 0 !== p.split || void 0 !== p.config && void 0 !== p.config.split, i);
                        if (h) {
                            if (null != s ? (t.splice(s, 0, h),
                            s++) : t.push(h),
                            h.conf.buttons && (h.collection = x("<" + c.container.content.tag + "/>"),
                            ...
                            h.conf.split) {
                                ...
                                for (var b = 0; b < h.conf.split.length; b++) {
                                    ...
                                    "object" == typeof g && (g.parent = r,
                                    void 0 === g.collectionLayout && (g.collectionLayout = h.conf.collectionLayout),
                                    void 0 === g.dropup && (g.dropup = h.conf.dropup),
                                    void 0 === g.fade) && (g.fade = h.conf.fade)
                                }
                                this._expandButton(h.buttons, h.conf.buttons, h.conf.split, !a, a, s, h.conf)
                            }
                            h.conf.parent = r,
        ...
        _buildButton: function(n, t, e, o) {
            ...
            var s, r, a, l, c, u = this, d = this.c.dom, f = this.s.dt, p = x.extend(!0, {}, d.button);
            if (t && e && d.collection.split ? x.extend(!0, p, d.collection.split.action) : o || t ? x.extend(!0, p, d.collection.button) : e && x.extend(!0, p, d.split.button),
            n.spacer)
                return d = x("<" + p.spacer.tag + "/>").addClass("dt-button-spacer " + n.style + " " + p.spacer.className).html(i(n.text)),
                {
                    conf: n,
                    node: d,
                    inserter: d,
            ...
            if (n.available && !n.available(f, n) && !n.html)
                return !1;
            n.html ? c = x(n.html) : (r = function(t, n, e, o, i) {
                o.action.call(n.button(e), t, n, e, o, i),
                x(n.table().node()).triggerHandler("buttons-action.dt", [n.button(e), n, e, o])
            }
            ,
            a = function(t, n, e, o) {
                o.async ? (u.processing(e[0], !0),
                setTimeout(function() {
                    r(t, n, e, o, function() {
                        u.processing(e[0], !1)
                    })
            ...
            c = x("<" + d + "/>").addClass(p.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(t) {
                t.preventDefault(),
                !c.hasClass(p.disabled) && n.action && a(t, f, c, n),
                l && c.trigger("blur")
            ...
            s = p.liner.tag ? (d = x("<" + p.liner.tag + "/>").html(i(n.text)).addClass(p.liner.className),
            ...
            var h, b, g, m, v, y, d = this.c.dom.buttonContainer, d = d && d.tag ? x("<" + d.tag + "/>").addClass(d.className).append(c) : c;
            return this._addKey(n),
            this.c.buttonCreated && (d = this.c.buttonCreated(n, d)),
            e && (b = (h = t ? x.extend(!0, this.c.dom.split, this.c.dom.collection.split) : this.c.dom.split).wrapper,
            g = x("<" + b.tag + "/>").addClass(b.className).append(c),
            m = x.extend(n, {
        ...
        _keypress: function(s, r) {
            ...
            r._buttonsHandled || (a = function(t) {
                for (var n, e, o = 0, i = t.length; o < i; o++)
                    n = t[o].conf,
                    e = t[o].node,
                    !n.key || n.key !== s && (!x.isPlainObject(n.key) || n.key.key !== s || n.key.shiftKey && !r.shiftKey || n.key.altKey && !r.altKey || n.key.ctrlKey && !r.ctrlKey || n.key.metaKey && !r.metaKey) || (r._buttonsHandled = !0,
                    x(e).click()),
        ...
        _removeKey: function(t) {
            var n;
            t.key && (t = (x.isPlainObject(t.key) ? t.key : t).key,
        ...
        _resolveExtends: function(e) {
            ...
            for (e = t(e); e && e.extend; ) {
                ...
                if (!r)
                    return !1;
                var a = r.className;
                void 0 !== e.config && void 0 !== r.config && (e.config = x.extend({}, r.config, e.config)),
                e = x.extend({}, r, e),
        ...
        _popover: function(o, t, n) {
            function i() {
                ...
                x(u.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes()).attr("aria-expanded", "false"),
            ...
            var e, s, r, a, l, c, u = t, d = this.c, f = !1, p = x.extend({
                align: "button-left",
                autoClose: !1,
                background: !0,
            ...
            }, n), h = p.tag + "." + p.containerClassName.replace(/ /g, "."), b = t.node();
            !1 === o ? i() : ((d = x(u.buttons('[aria-haspopup="dialog"][aria-expanded="true"]').nodes())).length && (b.closest(h).length && (b = d.eq(0)),
            i()),
            n = x(".dt-button", o).length,
            d = "",
            3 === n ? d = "dtb-b3" : 2 === n ? d = "dtb-b2" : 1 === n && (d = "dtb-b1"),
            e = x("<" + p.tag + "/>").addClass(p.containerClassName).addClass(p.collectionLayout).addClass(p.splitAlignClass).addClass(d).css("display", "none").attr({
                "aria-modal": !0,
                role: "dialog"
            }),
            o = x(o).addClass(p.contentClassName).attr("role", "menu").appendTo(e),
            b.attr("aria-expanded", "true"),
            b.parents("body")[0] !== m.body && (b = m.body.lastChild),
            p.popoverTitle ? e.prepend('<div class="dt-button-collection-title">' + p.popoverTitle + "</div>") : p.collectionTitle && e.prepend('<div class="dt-button-collection-title">' + p.collectionTitle + "</div>"),
            p.closeButton && e.prepend('<div class="dtb-popover-close">&times;</div>').addClass("dtb-collection-closeable"),
            v(e.insertAfter(b), p.fade),
            n = x(t.table().container()),
            d = e.css("position"),
            "container" !== p.span && "dt-container" !== p.align || (b = b.parent(),
            e.css("width", n.width())),
            "absolute" === d ? (t = x(b[0].offsetParent),
            n = b.position(),
            d = b.offset(),
            a = t.offset(),
            s = t.position(),
            r = g.getComputedStyle(t[0]),
            a.height = t.outerHeight(),
            a.width = t.width() + parseFloat(r.paddingLeft),
            ...
            r = g.getComputedStyle(e[0]),
            (l = e.offset()).height = e.outerHeight(),
            l.width = e.outerWidth(),
            l.right = l.left + l.width,
            l.bottom = l.top + l.height,
            l.marginTop = parseFloat(r.marginTop),
            l.marginBottom = parseFloat(r.marginBottom),
            p.dropup && (t = n.top - l.height - l.marginTop - l.marginBottom),
            "button-right" !== p.align && !e.hasClass(p.rightAlignClassName) || (a = n.left - l.width + b.outerWidth()),
            "dt-container" !== p.align && "container" !== p.align || a < n.left && (a = -n.left),
            s.left + a + l.width > x(g).width() && (a = x(g).width() - l.width - s.left),
            d.left + a < 0 && (a = -d.left),
            s.top + t + l.height > x(g).height() + x(g).scrollTop() && (t = n.top - l.height - l.marginTop - l.marginBottom),
            ...
            p.background && _.background(!0, p.backgroundClassName, p.fade, p.backgroundHost || b),
            x("div.dt-button-background").on("click.dtb-collection", function() {}),
            ...
            setTimeout(function() {
                f = !1,
                x("body").on("click.dtb-collection", function(t) {
                    var n, e;
                    !f && (n = x.fn.addBack ? "addBack" : "andSelf",
                    e = x(t.target).parent()[0],
                    !x(t.target).parents()[n]().filter(o).length && !x(e).hasClass("dt-buttons") || x(t.target).hasClass("dt-button-background")) && i()
                }).on("keyup.dtb-collection", function(t) {
                    27 === t.keyCode && i()
                }).on("keydown.dtb-collection", function(t) {
                    var n = x("a, button", o)
                      , e = m.activeElement;
                    9 === t.keyCode && (-1 === n.index(e) ? (n.first().focus(),
                    t.preventDefault()) : t.shiftKey ? e === n[0] && (n.last().focus(),
                    t.preventDefault()) : e === n.last()[0] && (n.first().focus(),
                    t.preventDefault()))
                })
            }, 0))
        }
    ...
    _.background = function(t, n, e, o) {
        void 0 === e && (e = 400),
        o = o || m.body,
        t ? v(x("<div/>").addClass(n).css("display", "none").insertAfter(o), e) : y(x("div." + n), e, function() {
    ...
    _.instanceSelector = function(t, i) {
        ...
        (a = function(t) {
            ...
            if (Array.isArray(t))
                ...
                "string" == typeof t ? -1 !== t.indexOf(",") ? a(t.split(",")) : -1 !== (n = x.inArray(t.trim(), r)) && s.push(i[n].inst) : "number" == typeof t ? s.push(i[t].inst) : "object" == typeof t && s.push(t)
        }
        )(t),
        s)
    }
    ...
    _.buttonSelector = function(t, n) {
        for (var c = [], u = function(t, n, e) {
            ...
            if (Array.isArray(t) || t instanceof x)
                ...
                "object" == typeof t && t.nodeName && -1 !== (a = x.inArray(t, o)) && c.push({
                    inst: n,
                    node: o[a]
                })
    ...
    _.stripData = function(t, n) {
        return t = "string" == typeof t && (t = (t = t.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, "")).replace(/<!\-\-.*?\-\->/g, ""),
        n && !n.stripHtml || (t = t.replace(/<[^>]*>/g, "")),
        n && !n.trim || (t = t.replace(/^\s+|\s+$/g, "")),
        n && !n.stripNewlines || (t = t.replace(/\n/g, " ")),
        !n || n.decodeEntities) ? i ? i(t) : (c.innerHTML = t,
        c.value) : t
    }
    ,
    ...
    x.extend(w, {
        collection: {
            ...
            action: function(t, n, e, o) {
                ...
                "keypress" === t.type && x("a, button", o._collection).eq(0).focus()
            },
            attr: {
                "aria-haspopup": "dialog"
            }
        ...
        csv: function(t, n) {
            if (w.csvHtml5 && w.csvHtml5.available(t, n))
                return "csvHtml5"
        },
        excel: function(t, n) {
        ...
        pdf: function(t, n) {
            if (w.pdfHtml5 && w.pdfHtml5.available(t, n))
                return "pdfHtml5"
        },
        pageLength: function(t) {
            ...
            if (Array.isArray(n[0]))
                ...
                for (var i = 0; i < n.length; i++) {
                    var s = n[i];
                    x.isPlainObject(s) ? (e.push(s.value),
    ...
    e.Api.register("buttons().containers()", function() {
        ...
        return this.iterator(!0, "table", function(t) {
            if (t._buttons)
                for (var n = _.instanceSelector(s, t._buttons), e = 0, o = n.length; e < o; e++)
    ...
    e.Api.register("button().add()", function(t, n, e) {
        var o = this.context;
        return o.length && (o = _.instanceSelector(this._groupSelector, o[0]._buttons)).length && o[0].add(n, t, e),
    ...
    e.Api.register("buttons.info()", function(t, n, e) {
        ...
        clearTimeout(s),
        s = null) : (s && clearTimeout(s),
        x("#datatables_buttons_info").length && x("#datatables_buttons_info").remove(),
        t = t ? "<h2>" + t + "</h2>" : "",
        v(x('<div id="datatables_buttons_info" class="dt-button-info"/>').html(t).append(x("<div/>")["string" == typeof n ? "html" : "append"](n)).css("display", "none").appendTo("body")),
        void 0 !== e && 0 !== e && (s = setTimeout(function() {
            o.buttons.info(!1)
        }, e)),
    ...
    var s, n = function(t, n) {
        var e;
        return null == (e = "function" == typeof (e = "*" === t.filename && "*" !== t.title && void 0 !== t.title && null !== t.title && "" !== t.title ? t.title : t.filename) ? e(t, n) : e) ? null : (e = (e = -1 !== e.indexOf("*") ? e.replace("*", x("head > title").text()).trim() : e).replace(/[^a-zA-Z0-9_\u00A1-\uFFFF\.,\-_ !\(\)]/g, "")) + (r(t.extension, t, n) || "")
    }, r = function(t, n, e) {
        ...
        e = r(e, n, t);
        return null === e ? null : (n = x("caption", t.table().container()).eq(0),
        "*" === e ? n.css("caption-side") !== o ? null : n.length ? n.text() : "" : e)
    }, c = x("<textarea/>")[0], u = function(i, t) {
        for (var s = x.extend(!0, {}, {
            ...
            var n, e = i.column(t).footer(), o = "";
            return e && (o = ((n = x(".dt-column-title", e)).length ? n : x(e)).html()),
            s.format.footer(o, t, e)
        ...
        i.rows(s.rows, e).indexes().toArray()), o = i.cells(o, s.columns, {
            ...
            for (var h = [c], b = 0; b < c; b++)
                h[b] = s.format.body(r[d], l[d].row, l[d].column, a[d]),
                d++;
            u[f] = h
        }
        e = {
        ...
        return s.customizeData && s.customizeData(e),
        e
    };
    function A(t, n) {
    ...
    return x.fn.dataTable.Buttons = _,
...
!function(n) {
    var o, d;
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-dt", "datatables.net-buttons"], function(e) {
        return n(e, window, document)
    }) : "object" == typeof exports ? (o = require("jquery"),
    d = function(e, t) {
        t.fn.dataTable || require("datatables.net-dt")(e, t),
        t.fn.dataTable.Buttons || require("datatables.net-buttons")(e, t)
    }
    ,
    "undefined" == typeof window ? module.exports = function(e, t) {
        return e = e || window,
    ...
    : (d(window, o),
    module.exports = n(o, window, window.document))) : n(jQuery, window, document)
}(function(e, t, n) {
    "use strict";
    return e.fn.dataTable
});
...
!function(o) {
    ...
    }) : "object" == typeof exports ? (i = require("jquery"),
    s = function(t, e) {
    ...
    : (s(window, i),
    module.exports = o(i, window, window.document))) : o(jQuery, window, document)
}(function(b, m, v) {
    "use strict";
    function s(t, e) {
        if (!d.versionCheck("2"))
        ...
        if (!0 === e && (e = {}),
        t = new d.Api(t),
        this.c = b.extend(!0, {}, s.defaults, e),
        this.s = {
            dt: t,
            position: {
                theadTop: 0,
        ...
        this.dom = {
            floatingHeader: null,
            thead: b(t.table().header()),
            tbody: b(t.table().body()),
            tfoot: b(t.table().footer()),
            header: {
                host: null,
                floating: null,
                floatingParent: b('<div class="dtfh-floatingparent"><div></div></div>'),
                placeholder: null
            },
            footer: {
                host: null,
    ...
    var d = b.fn.dataTable
      , o = 0;
    return b.extend(s.prototype, {
        destroy: function() {
            var t = this.dom;
            this.s.dt.off(".dtfc"),
            b(m).off(this.s.namespace),
        ...
        headerOffset: function(t) {
            return void 0 !== t && (this.c.headerOffset = t,
            this.update()),
            this.c.headerOffset
        },
        footerOffset: function(t) {
            return void 0 !== t && (this.c.footerOffset = t,
            this.update()),
            this.c.footerOffset
        },
        update: function(t) {
            var e = this.s.dt.table().node();
            (this.s.enable || this.s.autoDisable) && (b(e).is(":visible") ? (this.s.autoDisable = !1,
            this.enable(!0, !1)) : (this.s.autoDisable = !0,
            this.enable(!1, !1)),
            0 !== b(e).children("thead").length) && (this._positions(),
            this._scroll(void 0 === t || t),
        ...
        _constructor: function() {
            var o = this
              , i = this.s.dt
              , t = (b(m).on("scroll" + this.s.namespace, function() {
                o._scroll()
            }).on("resize" + this.s.namespace, d.util.throttle(function() {
                o.s.position.windowHeight = b(m).height(),
                o.update()
            }, 50)),
            b(".fh-fixedHeader"))
              , t = (!this.c.headerOffset && t.length && (this.c.headerOffset = t.outerHeight()),
            b(".fh-fixedFooter"));
        ...
        _clone: function(t, e) {
            var o, i, s = this, d = this.s.dt, n = this.dom[t], r = "header" === t ? this.dom.thead : this.dom.tfoot;
            "footer" === t && this._scrollEnabled() || (!e && n.floating ? n.floating.removeClass("fixedHeader-floating fixedHeader-locked") : (n.floating && (null !== n.placeholder && n.placeholder.remove(),
            n.floating.children().detach(),
            n.floating.remove()),
            e = b(d.table().node()),
            o = b(e.parent()),
            i = this._scrollEnabled(),
            n.floating = b(d.table().node().cloneNode(!1)).attr("aria-hidden", "true").css({
                top: 0,
                left: 0
            }).removeAttr("id"),
            n.floatingParent.css({
            ...
            }).addClass("footer" === t ? "dtfh-floatingparent-foot" : "dtfh-floatingparent-head").appendTo("body").children().eq(0).append(n.floating),
            this._stickyPosition(n.floating, "-"),
            (i = function() {
                var t = o.scrollLeft();
                s.s.scrollLeft = {
                    footer: t,
                ...
                n.floatingParent.scrollLeft(s.s.scrollLeft.header)
            }
            )(),
            o.off("scroll.dtfh").on("scroll.dtfh", i),
            n.floatingParent.children().css({
                width: "fit-content",
                paddingRight: s.s.dt.settings()[0].oBrowser.barWidth
            }),
            (e = b("footer" === t ? "div.dtfc-bottom-blocker" : "div.dtfc-top-blocker", d.table().container())).length && e.clone().appendTo(n.floatingParent).css({
                position: "fixed",
                right: e.width()
            }),
            n.placeholder = r.clone(!1),
            n.placeholder.find("*[id]").removeAttr("id"),
            n.host.prepend(n.placeholder),
            n.floating.append(r),
            this._widths(n)))
        },
        _stickyPosition: function(t, e) {
            var i;
            this._scrollEnabled() && (i = "rtl" === b(this.s.dt.table().node()).css("direction"),
            t.find("th").each(function() {
                var t, e, o;
                "sticky" === b(this).css("position") && (t = b(this).css("right"),
                e = b(this).css("left"),
                "auto" === t || i ? "auto" !== e && i && (o = +e.replace(/px/g, ""),
                b(this).css("left", 0 < o ? o : 0)) : (o = +t.replace(/px/g, ""),
                b(this).css("right", 0 < o ? o : 0)))
            }))
        },
        _horizontal: function(t, e) {
            var o, i = this.dom[t], s = this.s.scrollLeft;
            i.floating && s[t] !== e && (this._scrollEnabled() && (o = b(b(this.s.dt.table().node()).parent()).scrollLeft(),
            i.floating.scrollLeft(o),
            i.floatingParent.scrollLeft(o)),
            s[t] = e)
        },
        _modeChange: function(t, e, o) {
            var i, s, d, n, r, a, f, h = this.dom[e], l = this.s.position, c = this._scrollEnabled();
            "footer" === e && c || (i = function(t) {
                h.floating[0].style.setProperty("width", t + "px", "important"),
                c || h.floatingParent[0].style.setProperty("width", t + "px", "important")
            }
            ,
            n = this.dom["footer" === e ? "tfoot" : "thead"],
            s = b.contains(n[0], v.activeElement) ? v.activeElement : null,
            r = b(b(this.s.dt.table().node()).parent()),
            "in-place" === t ? (h.placeholder && (h.placeholder.remove(),
            h.placeholder = null),
            "header" === e ? h.host.prepend(n) : h.host.append(n),
            h.floating && (h.floating.remove(),
            h.floating = null,
            this._stickyPosition(h.host, "+")),
            h.floatingParent && (h.floatingParent.find("div.dtfc-top-blocker").remove(),
            h.floatingParent.remove()),
            b(b(h.host.parent()).parent()).scrollLeft(r.scrollLeft())) : "in" === t ? (this._clone(e, o),
            n = r.offset(),
            f = (d = b(v).scrollTop()) + b(m).height(),
            a = c ? n.top : l.tbodyTop,
            n = c ? n.top + r.outerHeight() : l.tfootTop,
            r = "footer" === e ? f < a ? l.tfootHeight : a + l.tfootHeight - f : d + this.c.headerOffset + l.theadHeight - n,
            a = "header" === e ? "top" : "bottom",
            f = this.c[e + "Offset"] - (0 < r ? r : 0),
            h.floating.addClass("fixedHeader-floating"),
            h.floatingParent.css(a, f).css({
                left: l.left,
                "z-index": 3
            }),
            i(l.width),
            "footer" === e && h.floating.css("top", "")) : "below" === t ? (this._clone(e, o),
            ...
            i(l.width)) : "above" === t && (this._clone(e, o),
            h.floating.addClass("fixedHeader-locked"),
            h.floatingParent.css({
                position: "absolute",
                top: l.tbodyTop,
            ...
            i(l.width)),
            s && s !== v.activeElement && setTimeout(function() {
                s.focus()
            }, 10),
        ...
        _positions: function() {
            ...
            o.theadTop = d.offset().top,
            o.tbodyTop = (s ? n : i).offset().top,
            o.tbodyHeight = (s ? n : i).outerHeight(),
            o.theadHeight = d.outerHeight(),
            o.theadBottom = o.theadTop + o.theadHeight,
            o.tfootTop = o.tbodyTop + o.tbodyHeight,
            t.length ? (o.tfootBottom = o.tfootTop + t.outerHeight(),
            o.tfootHeight = t.outerHeight()) : (o.tfootBottom = o.tfootTop,
            o.tfootHeight = 0)
        },
        _scroll: function(t) {
            var e, o, i, s, d, n, r, a, f, h, l, c, p, g, u;
            this.s.dt.settings()[0].bDestroying || (e = this._scrollEnabled(),
            i = (o = b(this.s.dt.table().node()).parent()).offset(),
            h = o.outerHeight(),
            s = b(v).scrollLeft(),
            d = b(v).scrollTop(),
            n = b(m).height() + d,
            l = this.s.position,
            c = e ? i.top : l.tbodyTop,
            a = (e ? i : l).left,
            h = e ? i.top + h : l.tfootTop,
            f = e ? o.outerWidth() : l.tbodyWidth,
            this.c.header && (!this.s.enable || !l.visible || d + this.c.headerOffset + l.theadHeight <= c ? r = "in-place" : d + this.c.headerOffset + l.theadHeight > c && d + this.c.headerOffset + l.theadHeight < h ? (r = "in",
            d + this.c.headerOffset + l.theadHeight > h || void 0 === this.dom.header.floatingParent ? t = !0 : this.dom.header.floatingParent.css({
                top: this.c.headerOffset,
                position: "fixed"
            }).children().eq(0).append(this.dom.header.floating)) : r = "below",
            !t && r === this.s.headerMode || this._modeChange(r, "header", t),
            ...
            this.c.footer && this.dom.tfoot.length && this.dom.tfoot.find("th, td").length && (!this.s.enable || !l.visible || l.tfootBottom + this.c.footerOffset <= n ? u = "in-place" : h + l.tfootHeight + this.c.footerOffset > n && c + this.c.footerOffset < n ? (u = "in",
            t = !0) : u = "above",
            !t && u === this.s.footerMode || this._modeChange(u, "footer", t),
            ...
            ,
            p = this.dom.header.floating ? h(this.dom.header.floating) : h(this.dom.thead),
            g = this.dom.footer.floating ? h(this.dom.footer.floating) : h(this.dom.tfoot),
            e) && g.offset.top > d && (c = n + ((l = d - i.top) > -p.height ? l : 0) - (p.offset.top + (l < -p.height ? p.height : 0) + g.height),
            o.outerHeight(c = c < 0 ? 0 : c),
            Math.round(o.outerHeight()) >= Math.round(c) ? b(this.dom.tfoot.parent()).addClass("fixedHeader-floating") : b(this.dom.tfoot.parent()).removeClass("fixedHeader-floating")),
            this.dom.header.floating && this.dom.header.floatingParent.css("left", a - s),
            this.dom.footer.floating && this.dom.footer.floatingParent.css("left", a - s),
            void 0 !== this.s.dt.settings()[0]._fixedColumns && (this.dom.header.rightBlocker = (u = function(t, e, o) {
                var i;
                return null !== (o = void 0 === o ? 0 === (i = b("div.dtfc-" + t + "-" + e + "-blocker")).length ? null : i.clone().css("z-index", 1) : o) && ("in" === r || "below" === r ? o.appendTo("body").css({
                    top: ("top" === e ? p : g).offset.top,
                    left: "right" === t ? a + f - o.width() : a
                }) : o.detach()),
                o
            }
            )("right", "top", this.dom.header.rightBlocker),
            this.dom.header.leftBlocker = u("left", "top", this.dom.header.leftBlocker),
            this.dom.footer.rightBlocker = u("right", "bottom", this.dom.footer.rightBlocker),
            this.dom.footer.leftBlocker = u("left", "bottom", this.dom.footer.leftBlocker)))
        },
        ...
        _widths: function(t) {
            if (t && t.placeholder)
                for (var e = b(this.s.dt.table().node()), o = b(e.parent()), i = (t.floatingParent.css("width", o[0].offsetWidth),
                t.floating.css("width", e[0].offsetWidth),
                b("colgroup", t.floating).remove(),
                t.placeholder.parent().find("colgroup").clone().appendTo(t.floating).find("col")), s = this.s.dt.columns(":visible").widths(), d = 0; d < s.length; d++)
                    i.eq(d).css("width", s[d])
        }
    }),
    s.version = "4.0.1",
    s.defaults = {
    ...
    b.fn.dataTable.FixedHeader = s,
    b.fn.DataTable.FixedHeader = s,
    b(v).on("init.dt.dtfh", function(t, e, o) {
        var i;
        "dt" === t.namespace && (t = e.oInit.fixedHeader,
        i = d.defaults.fixedHeader,
        t || i) && !e._fixedHeader && (i = b.extend({}, i, t),
        !1 !== t) && new s(e,i)
    }),
    d.Api.register("fixedHeader()", function() {}),
    d.Api.register("fixedHeader.adjust()", function() {
        return this.iterator("table", function(t) {
            t = t._fixedHeader;
            t && t.update()
        })
    }),
    d.Api.register("fixedHeader.enable()", function(e) {
        return this.iterator("table", function(t) {
            t = t._fixedHeader;
            e = void 0 === e || e,
    ...
    d.Api.register("fixedHeader.enabled()", function() {
        if (this.context.length) {
    ...
    d.Api.register("fixedHeader.disable()", function() {
        return this.iterator("table", function(t) {
            t = t._fixedHeader;
            t && t.enabled() && t.enable(!1)
        })
    }),
    b.each(["header", "footer"], function(t, o) {
        d.Api.register("fixedHeader." + o + "Offset()", function(e) {
            var t = this.context;
            return void 0 === e ? t.length && t[0]._fixedHeader ? t[0]._fixedHeader[o + "Offset"]() : void 0 : this.iterator("table", function(t) {
                t = t._fixedHeader;
                t && t[o + "Offset"](e)
            })
        })
...
!function(n) {
    var d, a;
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-dt", "datatables.net-fixedheader"], function(e) {
        return n(e, window, document)
    }) : "object" == typeof exports ? (d = require("jquery"),
    a = function(e, t) {
        t.fn.dataTable || require("datatables.net-dt")(e, t),
        t.fn.dataTable.FixedHeader || require("datatables.net-fixedheader")(e, t)
    }
    ,
    "undefined" == typeof window ? module.exports = function(e, t) {
        return e = e || window,
    ...
    : (a(window, d),
    module.exports = n(d, window, window.document))) : n(jQuery, window, document)
}(function(e, t, n) {
    "use strict";
    return e.fn.dataTable
});
...
!function(n) {
    ...
    : (r(window, i),
    module.exports = n(i, window, window.document))) : n(jQuery, window, document)
}(function(m, v, d) {
    "use strict";
    function a(e, t) {
        ...
        this.c = m.extend(!0, {}, a.defaults, i.defaults.responsive, t),
      ...
      , e = (m.extend(a.prototype, {
        _constructor: function() {
            var s = this
              , r = this.s.dt
              , t = m(v).innerWidth()
              , e = (r.settings()[0]._responsive = this,
            m(v).on("orientationchange.dtr", i.util.throttle(function() {
            ...
            r.on("destroy.dtr", function() {
                ...
                m(v).off("resize.dtr orientationchange.dtr"),
                r.cells(".dtr-control").nodes().to$().removeClass("dtr-control"),
                m(r.table().node()).removeClass("dtr-inline collapsed"),
                m.each(s.s.current, function(e, t) {
            ...
            m(r.table().node()).addClass("dtr-" + e.type)),
            ...
            r.on("draw.dtr", function() {
                ...
                "dt" === e.namespace && (s._resizeAuto(),
                s._resize(),
                m.inArray(!1, s.s.current)) && r.columns.adjust()
            }),
            this._resize()
        },
        ...
        _childNodesRestore: function(e, t, n) {
            ...
            if (this.s.childNodeStore[i]) {
                ...
                if (0 < e.length) {
                    for (var s = e[0].parentNode.childNodes, o = [], d = 0, a = s.length; d < a; d++)
                        o.push(s[d]);
        ...
        _columnsVisiblity: function(n) {
            ...
            d = t.length; o < d; o++) {
                var u = t[o].columnIdx;
                "-" === r[u] && !e[u].control && e[u].minWidth && (c || l - e[u].minWidth < 0 ? r[u] = !(c = !0) : r[u] = !0,
                l -= e[u].minWidth)
            }
            var h = !1;
            for (o = 0,
        ...
        _classLogic: function() {
            ...
            c.each(function(e, r) {
                for (var t = e.className.split(" "), s = !1, n = 0, i = t.length; n < i; n++) {
                    ...
                    if ("all" === o || "dtr-all" === o)
                        return s = !0,
                        void (e.includeIn = m.map(l, function(e) {
                            return e.name
                        }));
                    ...
                    m.each(l, function(e, t) {
                        var n = t.name.split("-")
                          ...
                          , i = o.match(i);
                        i && (s = !0,
                        i[2] === n[0] && i[3] === "-" + n[1] ? d(r, t.name, i[1], i[2] + i[3]) : i[2] !== n[0] || i[3] || d(r, t.name, i[1], i[2]))
                    })
                }
                s || (e.auto = !0)
            }),
        ...
        _detailsDisplay: function(t, n) {
            function e(e) {
                m(t.node()).toggleClass("dtr-expanded", !1 !== e),
                m(s.table().node()).triggerHandler("responsive-display.dt", [s, t, e, n])
            }
            var i, r = this, s = this.s.dt, o = this.c.details;
            o && !1 !== o.type && (i = "string" == typeof o.renderer ? a.renderer[o.renderer]() : o.renderer,
            "boolean" == typeof (o = o.display(t, n, function() {
        ...
        _detailsInit: function() {
            var n = this
              , i = this.s.dt
              , e = this.c.details
              , r = ("inline" === e.type && (e.target = "td.dtr-control, th.dtr-control"),
            i.on("draw.dtr", function() {
                n._tabIndexes()
            }),
            n._tabIndexes(),
            m(i.table().body()).on("keyup.dtr", "td, th", function(e) {
        ...
        _resize: function(n) {
            for (var e, i = this, r = this.s.dt, t = m(v).innerWidth(), s = this.c.breakpoints, o = s[0].name, d = this.s.columns, a = this.s.current.slice(), l = s.length - 1; 0 <= l; l--)
                if (t <= s[l].width) {
                    o = s[l].name;
                    break
                }
            ...
            for (l = 0,
            e = d.length; l < e; l++)
                if (!1 === c[l] && !d[l].never && !d[l].control && !1 == !r.column(l).visible()) {
                    u = !0;
                    break
                }
            ...
            r.columns().eq(0).each(function(e, t) {
                r.column(e).visible() && (!0 === c[t] && p++,
                !n && c[t] === a[t] || (h = !0,
                i._setColumnVis(e, c[t])),
                c[t] || m(f.aoColumns[e].colEl).detach())
            }),
            h && (this._redrawChildren(),
            m(r.table().node()).trigger("responsive-resize.dt", [r, this._responsiveOnlyHidden()]),
            0 === r.page.info().recordsDisplay) && m("td", r.table().body()).eq(0).attr("colspan", p),
            i._controlClass()
        },
        _resizeAuto: function() {
            ...
            if (this.c.auto && -1 !== m.inArray(!0, m.map(n, function(e) {
                ...
                for (var i = t.table().node().cloneNode(!1), s = m(t.table().header().cloneNode(!1)).appendTo(i), o = m(t.table().footer().cloneNode(!1)).appendTo(i), d = m(t.table().body()).clone(!1, !1).empty().appendTo(i), a = (i.style.width = "auto",
                t.table().header.structure(e).forEach(e=>{
                ...
                m("<tr/>").appendTo(d)), l = 0; l < e.count(); l++)
                    a.append("<td/>");
                t.rows({
                    page: "current"
                }).every(function(n) {
                ...
                t.table().footer.structure(e).forEach(e=>{
                    e = e.filter(function(e) {
                        return !!e
                    }).map(function(e) {
                        return m(e.cell).clone(!1).css("display", "table-cell").css("width", "auto").css("min-width", 0)
                ...
                "inline" === this.c.details.type && m(i).addClass("dtr-inline collapsed"),
                m(i).find("[name]").removeAttr("name"),
                m(i).css("position", "relative");
                i = m("<div/>").css({
                    width: 1,
                    height: 1,
                    overflow: "hidden",
        ...
        _setColumnVis: function(e, t) {
            ...
            m.isEmptyObject(this.s.childNodeStore) || i.cells(null, e).indexes().each(function(e) {
        ...
        _setHeaderVis: function(n, i, e) {
            ...
            e.forEach(function(e) {
                if (e[n])
                    m(e[n].cell).css("display", s).toggleClass("dtr-hidden", !i);
                else
                    for (var t = n; 0 <= t; ) {
                        if (e[t]) {
        ...
        details: {
            display: (a.display = {
                childRow: function(e, t, n) {
                    var i = m(e.node());
                    return t ? i.hasClass("dtr-expanded") ? (e.child(n(), "child").show(),
                    !0) : void 0 : i.hasClass("dtr-expanded") ? (e.child(!1),
                    !1) : !1 !== (t = n()) && (e.child(t, "child").show(),
                    !0)
                },
                childRowImmediate: function(e, t, n) {
                    var i = m(e.node());
                    return !t && i.hasClass("dtr-expanded") || !e.responsive.hasHidden() ? (e.child(!1),
                    !1) : !1 !== (t = n()) && (e.child(t, "child").show(),
                    !0)
                },
                modal: function(o) {
                    return function(e, t, n, i) {
                        ...
                        if (!1 === n)
                            return !1;
                        if (t) {
                            if (!(s = m("div.dtr-modal-content")).length || e.index() !== s.data("dtr-row-idx"))
                                return null;
                            s.empty().append(n)
                        } else {
                            var r = function() {
                                s.remove(),
                                m(d).off("keypress.dtr"),
                                m(e.node()).removeClass("dtr-expanded"),
                                i()
                            }
                            ...
                            m(e.node()).addClass("dtr-expanded"),
                            m(d).on("keyup.dtr", function(e) {
                                27 === e.keyCode && (e.stopPropagation(),
                                r())
                            })
                        }
                        return o && o.header && m("div.dtr-modal-content").prepend("<h2>" + o.header(e) + "</h2>"),
                        !0
                    }
                }
            }).childRow,
                ...
                listHiddenNodes: function() {
                    return function(i, e, t) {
                        ...
                        return m.each(t, function(e, t) {
                            ...
                            m("<li " + n + ' data-dtr-index="' + t.columnIndex + '" data-dt-row="' + t.rowIndex + '" data-dt-column="' + t.columnIndex + '"><span class="dtr-title">' + t.title + "</span> </li>").append(m('<span class="dtr-data"/>').append(r._childNodes(i, t.rowIndex, t.columnIndex))).appendTo(s),
                            o = !0)
                        }),
                        !!o && s
                    }
    ...
    a.version = "3.0.1",
    m.fn.dataTable.Responsive = a,
    m.fn.DataTable.Responsive = a,
    m(d).on("preInit.dt.dtr", function(e, t, n) {
...
!function(t) {
    var o, d;
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-dt", "datatables.net-responsive"], function(e) {
        return t(e, window, document)
    }) : "object" == typeof exports ? (o = require("jquery"),
    d = function(e, n) {
        n.fn.dataTable || require("datatables.net-dt")(e, n),
        n.fn.dataTable.Responsive || require("datatables.net-responsive")(e, n)
    }
    ,
    "undefined" == typeof window ? module.exports = function(e, n) {
        return e = e || window,
...
!function(e) {
    ...
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net"], function(t) {
        return e(t, window, document)
    }) : "object" == typeof exports ? (n = require("jquery"),
    s = function(t, i) {
    ...
    : (s(window, n),
    module.exports = e(n, window, window.document))) : e(jQuery, window, document)
}(function(s, u, t) {
    "use strict";
    var I, c, a, d, l, h, p, m, e, i, f = s.fn.dataTable;
    function o() {
        return u.moment
    }
    function r() {
    ...
    function g(t, i, e, n, s, o, r) {
        if (void 0 === n && (n = 0),
        void 0 === s && (s = !1),
        void 0 === o && (o = 1),
        void 0 === r && (r = void 0),
        d && d.versionCheck && d.versionCheck("1.10.0"))
            return this.classes = a.extend(!0, {}, g.classes),
    ...
    function n(t, i) {
        ...
        if (!p || !p.versionCheck || !p.versionCheck("1.10.0"))
            throw new Error("SearchBuilder requires DataTables 1.10 or newer");
        t = new p.Api(t);
        if (this.classes = h.extend(!0, {}, n.classes),
    ...
    function v(t, i) {
        t = new f.Api(t),
        i = i || t.init().searchBuilder || f.defaults.searchBuilder;
    ...
    w.prototype.updateArrows = function(t) {
        ...
        this.setListeners(),
        void 0 !== this.dom.value[0] && I(this.dom.value[0]).trigger("dtsb-inserted");
        for (var i = 1; i < this.dom.value.length; i++)
            this.dom.inputCont.append(this.dom.value[i]),
            I(this.dom.value[i]).trigger("dtsb-inserted");
    ...
    w.prototype.search = function(t, i) {
        ...
        if (void 0 !== this.s.condition && void 0 !== n) {
            ...
            if (this.s.type.includes("num") && ("" !== e.oLanguage.sDecimal || "" !== e.oLanguage.sThousands)) {
                var o = [t[this.s.dataIdx]];
                if ("" !== e.oLanguage.sDecimal && (o = t[this.s.dataIdx].split(e.oLanguage.sDecimal)),
                "" !== e.oLanguage.sThousands)
                    for (var r = 0; r < o.length; r++)
                        o[r] = o[r].replace(e.oLanguage.sThousands, ",");
                s = o.join(".")
            }
            if ("filter" !== this.c.orthogonal.search && (s = e.fastData(i, this.s.dataIdx, "string" == typeof this.c.orthogonal ? this.c.orthogonal : this.c.orthogonal.search)),
            "array" === this.s.type) {
                (s = Array.isArray(s) ? s : [s]).sort();
                for (var a = 0, d = s; a < d.length; a++) {
                    var l = d[a];
                    l && "string" == typeof l && (l = l.replace(/[\r\n\u2028]/g, " "))
                }
            } else
                null !== s && "string" == typeof s && (s = s.replace(/[\r\n\u2028]/g, " "));
            return this.s.type.includes("html") && "string" == typeof s && (s = s.replace(/(<([^>]+)>)/gi, "")),
    ...
    w.prototype.getDetails = function(t) {
        void 0 === t && (t = !1);
        var i, e = this.s.dt.settings()[0];
        if (null === this.s.type || !this.s.type.includes("num") || "" === e.oLanguage.sDecimal && "" === e.oLanguage.sThousands) {
            if (null !== this.s.type && t)
                if (this.s.type.includes("date") || this.s.type.includes("time"))
                    ...
                    for (i = 0; i < this.s.value.length; i++)
                        this.s.value[i] && 0 < this.s.value[i].length && null === r().DateTime.fromFormat(this.s.value[i], this.s.dateFormat).invalid && (this.s.value[i] = r().DateTime.fromFormat(this.s.value[i], this.s.dateFormat).toFormat("yyyy-MM-dd HH:mm:ss"))
        } else
            for (i = 0; i < this.s.value.length; i++) {
                var n = [this.s.value[i].toString()];
                if ("" !== e.oLanguage.sDecimal && (n = this.s.value[i].split(e.oLanguage.sDecimal)),
                "" !== e.oLanguage.sThousands)
                    for (var s = 0; s < n.length; s++)
                        n[s] = n[s].replace(e.oLanguage.sThousands, ",");
                this.s.value[i] = n.join(".")
            }
    ...
    ,
    w.prototype.parseNumber = function(t) {
        var i = this.s.dt.i18n("decimal");
        return +(t = i && "." !== i ? t.replace(/\./g, "").replace(i, ".") : t).replace(/(?!^-)[^0-9.]/g, "")
    }
    ,
    w.prototype.populate = function() {
        this._populateData(),
        -1 !== this.s.dataIdx && (this._populateCondition(),
        void 0 !== this.s.condition) && this._populateValue()
    }
    ,
    w.prototype.rebuild = function(t) {
        var i, e, n, s = !1;
        if (this._populateData(),
        void 0 !== t.data && (e = this.classes.italic,
        n = this.dom.data,
        this.dom.data.children("option").each(function() {
            !s && (I(this).text() === t.data || t.origData && I(this).prop("origData") === t.origData) ? (I(this).prop("selected", !0),
            n.removeClass(e),
            s = !0,
            i = parseInt(I(this).val(), 10)) : I(this).removeProp("selected")
        })),
        s) {
            this.s.data = t.data,
            ...
            for (var o = void 0, r = this.dom.condition.children("option"), a = 0; a < r.length; a++) {
                var d = I(r[a]);
                void 0 !== t.condition && d.val() === t.condition && "string" == typeof t.condition ? (d.prop("selected", !0),
                o = d.val()) : d.removeProp("selected")
            }
            if (this.s.condition = o,
            void 0 !== this.s.condition) {
                for (this.dom.conditionTitle.removeProp("selected"),
                this.dom.conditionTitle.remove(),
                this.dom.condition.removeClass(this.classes.italic),
                a = 0; a < r.length; a++) {
                    var l = I(r[a]);
                    l.val() !== this.s.condition && l.removeProp("selected")
                }
    ...
    w.prototype.setListeners = function() {
        ...
        this.dom.data.unbind("change").on("change.dtsb", function() {
            ...
            for (var t = l.dom.data.children("option." + l.classes.option), i = 0; i < t.length; i++) {
                var e = I(t[i]);
                e.val() === l.dom.data.val() ? (l.dom.data.removeClass(l.classes.italic),
                e.prop("selected", !0),
                l.s.dataIdx = +e.val(),
                l.s.data = e.text(),
                ...
                l.s.filled && (l.s.filled = !1,
                l.doSearch(),
                l.setListeners()),
                l.s.dt.state.save()) : e.removeProp("selected")
            }
        }),
        this.dom.condition.unbind("change").on("change.dtsb", function() {
            ...
            for (var t = l.dom.condition.children("option." + l.classes.option), i = 0; i < t.length; i++) {
                ...
                if (e.val() === l.dom.condition.val()) {
                    ...
                    e.prop("selected", !0);
                    for (var n = e.val(), s = 0, o = Object.keys(l.s.conditions); s < o.length; s++)
                        if (o[s] === n) {
                            l.s.condition = n;
                            break
                        }
                    l._clearValue(),
                    l._populateValue();
                    for (var r = 0, a = l.dom.value; r < a.length; r++) {
                        var d = a[r];
                        l.s.filled && void 0 !== d && 0 !== l.dom.inputCont.has(d[0]).length && (l.s.filled = !1,
                        l.doSearch(),
                        l.setListeners())
                    }
                    (0 === l.dom.value.length || 1 === l.dom.value.length && void 0 === l.dom.value[0]) && l.doSearch()
                } else
    ...
    w.prototype.setupButtons = function() {
        550 < u.innerWidth ? (this.dom.container.removeClass(this.classes.vertical),
        this.dom.buttons.css("left", null),
        this.dom.buttons.css("top", null)) : (this.dom.container.addClass(this.classes.vertical),
    ...
    w.prototype._clearValue = function() {
        ...
        if (void 0 !== this.s.condition) {
            if (0 < this.dom.value.length && void 0 !== this.dom.value[0])
                for (var i = 0, e = this.dom.value; i < e.length; i++)
                    void 0 !== (t = e[i]) && setTimeout(function() {
                        t.remove()
                    }, 50);
            if (this.dom.value = [].concat(this.s.conditions[this.s.condition].init(this, w.updateListener)),
            0 < this.dom.value.length && void 0 !== this.dom.value[0]) {
                ...
                I(this.dom.value[0]).trigger("dtsb-inserted");
                for (var n = 1; n < this.dom.value.length; n++)
                    this.dom.inputCont.append(this.dom.value[n]),
                    I(this.dom.value[n]).trigger("dtsb-inserted")
            }
        } else {
            for (var s = 0, o = this.dom.value; s < o.length; s++)
                void 0 !== (t = o[s]) && setTimeout(function() {
                    t.remove()
                }, 50);
    ...
    w.prototype._populateCondition = function() {
        ...
        if (0 === i) {
            this.s.type = this.s.dt.column(n).type(),
            void 0 !== e && (void 0 !== (s = e[n]).searchBuilderType && null !== s.searchBuilderType ? this.s.type = s.searchBuilderType : void 0 !== this.s.type && null !== this.s.type || (this.s.type = s.sType)),
            null !== this.s.type && void 0 !== this.s.type || (I.fn.dataTable.ext.oApi && I.fn.dataTable.ext.oApi._fnColumnTypes(this.s.dt.settings()[0]),
            this.s.type = this.s.dt.column(n).type()),
            ...
            var s = this.s.dt.settings()[0].oLanguage.sDecimal
              , o = ("" !== s && this.s.type.indexOf(s) === this.s.type.length - s.length && (this.s.type.includes("num-fmt") || this.s.type.includes("num")) && (this.s.type = this.s.type.replace(s, "")),
            void 0 !== this.c.conditions[this.s.type] ? this.c.conditions[this.s.type] : this.s.type.includes("moment") ? this.c.conditions.moment : this.s.type.includes("luxon") ? this.c.conditions.luxon : this.c.conditions.string);
            ...
            for (var r, a, d = 0, l = Object.keys(o); d < l.length; d++)
                null !== o[a = l[d]] && (this.s.dt.page.info().serverSide && o[a].init === w.initSelect && (r = e[n],
                this.s.serverData && this.s.serverData[r.data] ? (o[a].init = w.initSelectSSP,
                o[a].inputValue = w.inputValueSelect,
                o[a].isInputValid = w.isInputValidSelect) : (o[a].init = w.initInput,
                o[a].inputValue = w.inputValueInput,
                o[a].isInputValid = w.isInputValidInput)),
                this.s.conditions[a] = o[a],
                "function" == typeof (C = o[a].conditionName) && (C = C(this.s.dt, this.c.i18n)),
                t.push(I("<option>", {
                    text: C,
                    value: a
            ...
            for (var u = 0, c = Object.keys(this.s.conditions); u < c.length; u++) {
                a = c[u];
                var h = this.s.conditions[a].conditionName
                  , p = ("function" == typeof h && (h = h(this.s.dt, this.c.i18n)),
                I("<option>", {
                    text: h,
                    value: a
                }).addClass(this.classes.option).addClass(this.classes.notItalic));
                void 0 !== this.s.condition && this.s.condition === h && (p.prop("selected", !0),
                this.dom.condition.removeClass(this.classes.italic)),
                t.push(p)
            }
        }
        for (var m = 0, f = t; m < f.length; m++)
            this.dom.condition.append(f[m]);
        if (e[n].searchBuilder && e[n].searchBuilder.defaultCondition) {
            var g = e[n].searchBuilder.defaultCondition;
            if ("number" == typeof g)
                this.dom.condition.prop("selectedIndex", g),
                this.dom.condition.trigger("change");
            else if ("string" == typeof g)
                for (var v = 0; v < t.length; v++)
                    for (var b = 0, y = Object.keys(this.s.conditions); b < y.length; b++) {
                        var C, V = y[b];
                        if (("string" == typeof (C = this.s.conditions[V].conditionName) ? C : C(this.s.dt, this.c.i18n)) === t[v].text() && V === g) {
                            this.dom.condition.prop("selectedIndex", this.dom.condition.children().toArray().indexOf(t[v][0])).removeClass(this.classes.italic),
                            this.dom.condition.trigger("change"),
                            v = t.length;
                            break
                        }
    ...
    w.prototype._populateData = function() {
        ...
        for (var e, n, s = 0; s < t.length; s++)
            ...
            this.dom.data.append(I("<option>", {
                text: n.text,
                value: n.index
            }).addClass(this.classes.option).addClass(this.classes.notItalic).prop("origData", e.data).prop("selected", this.s.dataIdx === n.index)),
            this.s.dataIdx !== n.index) || this.dom.dataTitle.removeProp("selected")
    }
    ,
    w.prototype._populateValue = function(i) {
        for (var t, e = this, n = this.s.filled, s = (this.s.filled = !1,
        setTimeout(function() {
            e.dom.defaultValue.remove()
        }, 50),
        0), o = this.dom.value; s < o.length; s++)
            !function(t) {
                setTimeout(function() {
                    void 0 !== t && t.remove()
                }, 50)
        ...
        if (1 < r.length)
            for (t = 0; t < r.length; t++)
                I(r[t]).remove();
        for (void 0 !== i && this.s.dt.columns().every(function(t) {
            e.s.dt.settings()[0].aoColumns[t].sTitle === i.data && (e.s.dataIdx = t)
        }),
        this.dom.value = [].concat(this.s.conditions[this.s.condition].init(this, w.updateListener, void 0 !== i ? i.value : void 0)),
        void 0 !== i && void 0 !== i.value && (this.s.value = i.value),
        this.dom.inputCont.empty(),
        void 0 !== this.dom.value[0] && I(this.dom.value[0]).appendTo(this.dom.inputCont).trigger("dtsb-inserted"),
        t = 1; t < this.dom.value.length; t++)
            I(this.dom.value[t]).insertAfter(this.dom.value[t - 1]).trigger("dtsb-inserted");
        this.s.filled = this.s.conditions[this.s.condition].isInputValid(this.dom.value, this),
        this.setListeners(),
        this.s.preventRedraw || n === this.s.filled || (this.s.dt.page.info().serverSide || this.doSearch(),
        this.setListeners())
    }
    ,
    w.prototype._throttle = function(n, s) {
        var o = null
          , r = null
          , a = this;
        return null === (s = void 0 === s ? 200 : s) && (s = 200),
        function() {
            for (var t = [], i = 0; i < arguments.length; i++)
                t[i] = arguments[i];
            var e = +new Date;
            null !== o && e < o + s ? clearTimeout(r) : o = e,
            r = setTimeout(function() {
                o = null,
                n.apply(a, t)
            }, s)
    ...
    w.initSelect = function(e, t, n, i) {
        void 0 === n && (n = null),
        void 0 === i && (i = !1);
        for (var s = e.dom.data.children("option:selected").val(), o = e.s.dt.rows().indexes().toArray(), r = e.s.dt.settings()[0].fastData, a = (e.dom.valueTitle.prop("selected", !0),
        I("<select/>").addClass(w.classes.value).addClass(w.classes.dropDown).addClass(w.classes.italic).addClass(w.classes.select).append(e.dom.valueTitle).on("change.dtsb", function() {
            I(this).removeClass(w.classes.italic),
            t(e, this)
        })), d = (e.c.greyscale && a.addClass(w.classes.greyscale),
        []), l = [], u = 0, c = o; u < c.length; u++) {
            var h = c[u]
              , p = r(h, s, "string" == typeof e.c.orthogonal ? e.c.orthogonal : e.c.orthogonal.search)
              , m = {
                filter: "string" == typeof p ? p.replace(/[\r\n\u2028]/g, " ") : p,
                index: h,
                text: r(h, s, "string" == typeof e.c.orthogonal ? e.c.orthogonal : e.c.orthogonal.display)
            }
              , f = ("array" === e.s.type && (m.filter = Array.isArray(m.filter) ? m.filter : [m.filter],
            ...
            function(t, i) {
                ...
                i = t.val();
                -1 === d.indexOf(i) && (d.push(i),
                l.push(t),
                null !== n && Array.isArray(n[0]) && (n[0] = n[0].sort().join(",")),
                null !== n) && t.val() === n[0] && (t.prop("selected", !0),
    ...
    w.initSelectSSP = function(t, i, e) {
        ...
        []), o = 0, r = t.s.serverData[t.s.origData]; o < r.length; o++) {
            var a = r[o]
              , d = a.value
              , a = a.label;
            ...
            s.push(d),
            null !== e && d.val() === e[0] && (d.prop("selected", !0),
    ...
    w.initInput = function(i, e, t) {
        ...
        return i.c.greyscale && n.addClass(w.classes.greyscale),
        null !== t && n.val(t[0]),
    ...
    w.init2Input = function(i, e, t) {
        ...
        return i.c.greyscale && (n[0].addClass(w.classes.greyscale),
    ...
    w.initDate = function(e, n, t) {
        ...
        return e.c.greyscale && i.addClass(w.classes.greyscale),
        null !== t && i.val(t[0]),
    ...
    w.init2Date = function(e, n, t) {
        var i = this
          , s = (void 0 === t && (t = null),
        e.s.dt.settings()[0].searchDelay)
          , o = e.s.dt.i18n("datetime", {})
          , o = [I("<input/>").addClass(w.classes.value).addClass(w.classes.input).dtDateTime({
            attachTo: "input",
            format: e.s.dateFormat || void 0,
            i18n: o
        }).on("change.dtsb", null !== s ? f.util.throttle(function() {
            return n(e, this)
        }, s) : function() {
            n(e, i)
        }
        ).on("input.dtsb keypress.dtsb", function(i) {
            f.util.throttle(function() {
                var t = i.keyCode || i.which;
                return n(e, this, t)
            }, null === s ? 0 : s)
        ...
        ).on("input.dtsb keypress.dtsb", e.c.enterSearch || void 0 !== e.s.dt.settings()[0].oInit.search && e.s.dt.settings()[0].oInit.search.return || null === s ? function(t) {
            t = t.keyCode || t.which;
            n(e, i, t)
        }
        : f.util.throttle(function() {
        ...
        return e.c.greyscale && (o[0].addClass(w.classes.greyscale),
        o[2].addClass(w.classes.greyscale)),
        null !== t && 0 < t.length && (o[0].val(t[0]),
        o[2].val(t[1])),
        e.s.dt.one("draw.dtsb", function() {
            e.s.topGroup.trigger("dtsb-redrawLogic")
        }),
    ...
    w.updateListener = function(t, i, e) {
        ...
        if (t.s.filled = n.isInputValid(t.dom.value, t),
        t.s.value = n.inputValue(t.dom.value, t),
        t.s.filled) {
            for (Array.isArray(t.s.value) || (t.s.value = [t.s.value]),
            r = 0; r < t.s.value.length; r++)
                Array.isArray(t.s.value[r]) && t.s.value[r].sort();
            for (var s = null, o = null, r = 0; r < t.dom.value.length; r++)
                i === t.dom.value[r][0] && (s = r,
                void 0 !== i.selectionStart) && (o = i.selectionStart);
            (t.c.enterSearch || void 0 !== t.s.dt.settings()[0].oInit.search && t.s.dt.settings()[0].oInit.search.return) && 13 !== e || t.doSearch(),
            null !== s && (t.dom.value[s].removeClass(t.classes.italic),
            t.dom.value[s].focus(),
            null !== o) && t.dom.value[s][0].setSelectionRange(o, o)
        } else
            (t.c.enterSearch || void 0 !== t.s.dt.settings()[0].oInit.search && t.s.dt.settings()[0].oInit.search.return) && 13 !== e || t.doSearch()
    }
    ,
    ...
    w.luxonDateConditions = {
        "=": {
            ...
            isInputValid: w.isInputValidInput,
            search: function(t, i, e) {
                return r().DateTime.fromFormat(t, e.s.dateFormat).ts === r().DateTime.fromFormat(i[0], e.s.dateFormat).ts
            }
        },
        "!=": {
            conditionName: function(t, i) {
        ...
        between: {
            ...
            isInputValid: w.isInputValidInput,
            search: function(t, i, e) {
                var t = r().DateTime.fromFormat(t, e.s.dateFormat).ts
                  , n = r().DateTime.fromFormat(i[0], e.s.dateFormat).ts
                  , i = r().DateTime.fromFormat(i[1], e.s.dateFormat).ts;
                return n < i ? n <= t && t <= i : i <= t && t <= n
            }
        },
        "!between": {
    ...
    w.numFmtConditions = {
        ...
        between: {
            ...
            isInputValid: w.isInputValidInput,
            search: function(t, i, e) {
                var t = e.parseNumber(t)
                  , n = e.parseNumber(i[0])
                  , e = e.parseNumber(i[1]);
                return +n < +e ? +n <= +t && +t <= +e : +e <= +t && +t <= +n
            }
        },
        "!between": {
            conditionName: function(t, i) {
    ...
    g.prototype.rebuild = function(t) {
        var i;
        if (!(void 0 === t.criteria || null === t.criteria || Array.isArray(t.criteria) && 0 === t.criteria.length)) {
            if (this.s.logic = t.logic,
            this.dom.logic.children().first().html("OR" === this.s.logic ? this.s.dt.i18n("searchBuilder.logicOr", this.c.i18n.logicOr) : this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd)),
            Array.isArray(t.criteria))
                for (var e = 0, n = t.criteria; e < n.length; e++)
                    void 0 !== (i = n[e]).logic ? this._addPrevGroup(i) : void 0 === i.logic && this._addPrevCriteria(i);
            for (var s = 0, o = this.s.criteria; s < o.length; s++)
                (i = o[s]).criteria instanceof l && (i.criteria.updateArrows(1 < this.s.criteria.length),
                this._setCriteriaListeners(i.criteria))
        }
    }
    ,
    g.prototype.redrawContents = function() {
        if (!this.s.preventRedraw) {
            ...
            for (var t = 0; t < this.s.criteria.length; t++) {
                ...
                i instanceof l ? (this.s.criteria[t].index = t,
                this.s.criteria[t].criteria.s.index = t,
                this.s.criteria[t].criteria.dom.container.insertBefore(this.dom.add),
                this._setCriteriaListeners(i),
                this.s.criteria[t].criteria.s.preventRedraw = this.s.preventRedraw,
                this.s.criteria[t].criteria.rebuild(this.s.criteria[t].criteria.getDetails()),
                this.s.criteria[t].criteria.s.preventRedraw = !1) : i instanceof g && 0 < i.s.criteria.length ? (this.s.criteria[t].index = t,
                this.s.criteria[t].criteria.s.index = t,
                this.s.criteria[t].criteria.dom.container.insertBefore(this.dom.add),
                i.s.preventRedraw = this.s.preventRedraw,
                i.redrawContents(),
                i.s.preventRedraw = !1,
                this._setGroupListeners(i)) : (this.s.criteria.splice(t, 1),
                t--)
            }
            this.setupLogic()
        }
    ...
    g.prototype.setupLogic = function() {
        if (this.dom.logicContainer.remove(),
        this.dom.clear.remove(),
        this.s.criteria.length < 1)
            this.s.isChild || (this.dom.container.trigger("dtsb-destroy"),
            ...
            var n = this.dom.container.outerHeight() - 1
              , n = (this.dom.logicContainer.width(n),
    ...
    g.prototype.setListeners = function() {
        ...
        this.dom.add.on("click.dtsb", function() {
            return t.s.isChild || t.dom.container.prepend(t.dom.logicContainer),
            t.addCriteria(),
    ...
    g.prototype.addCriteria = function(t) {
        for (var i = null === (t = void 0 === t ? null : t) ? this.s.criteria.length : t.s.index, e = new l(this.s.dt,this.s.opts,this.s.topGroup,i,this.s.depth,this.s.serverData,this.c.liveSearch), n = (null !== t && (e.c = t.c,
        e.s = t.s,
        e.s.depth = this.s.depth,
        e.classes = t.classes),
        e.populate(),
        !1), s = 0; s < this.s.criteria.length; s++)
            0 === s && this.s.criteria[s].criteria.s.index > e.s.index ? (e.getNode().insertBefore(this.s.criteria[s].criteria.dom.container),
            n = !0) : s < this.s.criteria.length - 1 && this.s.criteria[s].criteria.s.index < e.s.index && this.s.criteria[s + 1].criteria.s.index > e.s.index && (e.getNode().insertAfter(this.s.criteria[s].criteria.dom.container),
            n = !0);
        ...
        for (var o = 0, r = this.s.criteria; o < r.length; o++) {
            var a = r[o];
    ...
    g.prototype._orSearch = function(t, i) {
        ...
        for (var e = !1, n = 0, s = this.s.criteria; n < s.length; n++) {
            var o = s[n];
            if (o.criteria instanceof l && o.criteria.s.filled) {
                if (e = !0,
                o.criteria.search(t, i))
                    return !0
            } else if (o.criteria instanceof g && o.criteria.checkFilled() && (e = !0,
            o.criteria.search(t, i)))
                return !0
        }
        return !e
    ...
    g.prototype._removeCriteria = function(t, i) {
        ...
        this.s.criteria.length <= 1 && this.s.isChild)
            ...
            for (void 0 !== e && this.s.criteria.splice(e, 1),
            n = 0; n < this.s.criteria.length; n++)
    ...
    g.prototype._setCriteriaListeners = function(n) {
        ...
        n.dom.left.unbind("click").on("click.dtsb", function() {
            s.s.toDrop = new l(s.s.dt,s.s.opts,s.s.topGroup,n.s.index,void 0,s.s.serverData),
            s.s.toDrop.s = n.s,
            s.s.toDrop.c = n.c,
            s.s.toDrop.classes = n.classes,
            s.s.toDrop.populate();
            var t = s.s.toDrop.s.index;
            return s.dom.container.trigger("dtsb-dropCriteria"),
            n.s.index = t,
            s._removeCriteria(n),
            s.s.topGroup.trigger("dtsb-redrawContents"),
            s.s.dt.draw(),
    ...
    g.prototype._setClearListener = function() {
        ...
        this.dom.clear.unbind("click").on("click.dtsb", function() {
            return t.s.isChild ? (t.destroy(),
            t.s.topGroup.trigger("dtsb-redrawContents")) : t.dom.container.trigger("dtsb-clearContents"),
            !1
        })
    }
    ,
    g.prototype._setGroupListeners = function(i) {
        ...
        i.dom.add.unbind("click").on("click.dtsb", function() {
            return e.setupLogic(),
            e.dom.container.trigger("dtsb-add"),
            !1
        }),
    ...
    g.prototype._toggleLogic = function() {
        "OR" === this.s.logic ? (this.s.logic = "AND",
        this.dom.logic.children().first().html(this.s.dt.i18n("searchBuilder.logicAnd", this.c.i18n.logicAnd))) : "AND" === this.s.logic && (this.s.logic = "OR",
    ...
    n.prototype.rebuild = function(t) {
        return this.dom.clearAll.click(),
        null != t && (this.s.topGroup.s.preventRedraw = !0,
    ...
    n.prototype._applyPreDefDefaults = function(t) {
        for (var e = this, n = (void 0 !== t.criteria && void 0 === t.logic && (t.logic = "AND"),
        this), i = 0, s = t.criteria; i < s.length; i++)
            !function(i) {
                void 0 !== i.criteria ? i = n._applyPreDefDefaults(i) : n.s.dt.columns().every(function(t) {
    ...
    n.prototype._setUp = function(t) {
        var n = this;
        if (void 0 === t && (t = !0),
        "function" != typeof this.s.dt.column().type && f.Api.registerPlural("columns().types()", "column().type()", function() {
            return this.iterator("column", function(t, i) {
                return t.aoColumns[i].sType
            }, 1)
        }),
        !p.DateTime) {
            if (void 0 === (i = this.s.dt.columns().types().toArray()) || i.includes(void 0) || i.includes(null))
                for (var i = [], e = 0, s = this.s.dt.settings()[0].aoColumns; e < s.length; e++) {
                    var o = s[e];
                    i.push(void 0 !== o.searchBuilderType ? o.searchBuilderType : o.sType)
                }
            var r = this.s.dt.columns().toArray();
            (void 0 === i || i.includes(void 0) || i.includes(null)) && (h.fn.dataTable.ext.oApi && h.fn.dataTable.ext.oApi._fnColumnTypes(this.s.dt.settings()[0]),
            ...
            for (var a = 0; a < r[0].length; a++) {
                ...
                if ((!0 === this.c.columns || Array.isArray(this.c.columns) && this.c.columns.includes(a)) && (d.includes("date") || d.includes("moment") || d.includes("luxon")))
                    throw alert("SearchBuilder Requires DateTime when used with dates."),
                    new Error("SearchBuilder requires DateTime")
            }
        }
        this.s.topGroup = new m(this.s.dt,this.c,void 0,void 0,void 0,void 0,this.s.serverData),
        this._setClearListener(),
        ...
        this.s.dt.on(p.versionCheck("2") ? "columns-reordered" : "column-reorder", function() {
            n.rebuild(n.getDetails())
        }),
        t && (null !== (t = this.s.dt.state.loaded()) && void 0 !== t.searchBuilder ? (this.s.topGroup.rebuild(t.searchBuilder),
        this.s.topGroup.dom.container.trigger("dtsb-redrawContents"),
        this.s.dt.page.info().serverSide || (t.page ? this.s.dt.page(t.page).draw("page") : this.s.dt.scroller && t.scroller && this.s.dt.scroller().scrollToRow(t.scroller.topRow)),
        this.s.topGroup.setListeners()) : !1 !== this.c.preDefined && (this.c.preDefined = this._applyPreDefDefaults(this.c.preDefined),
    ...
    n.prototype._collapseArray = function(t) {
        if (void 0 === t.logic)
            void 0 !== t.value && (t.value.sort(function(t, i) {
                return isNaN(+t) || (t = +t,
                i = +i),
                t < i ? -1 : i < t ? 1 : 0
            }),
    ...
    n.prototype._build = function() {
        var n = this
          , t = (this.dom.clearAll.remove(),
        this.dom.container.empty(),
        this.s.topGroup.count())
          , s = (this._updateTitle(t),
    ...
    n.prototype._checkClear = function() {
        0 < this.s.topGroup.s.criteria.length ? (this.dom.clearAll.insertAfter(this.dom.title),
        this._setClearListener()) : this.dom.clearAll.remove()
    }
    ,
    ...
    n.prototype._setClearListener = function() {
        ...
        this.dom.clearAll.on("click.dtsb", function() {
            return t.s.topGroup = new m(t.s.dt,t.c,void 0,void 0,void 0,void 0,t.s.serverData),
            t._build(),
            t.s.dt.draw(),
    ...
    f.ext.buttons.searchBuilder = {
        action: function(t, i, e, n) {
            ...
            void 0 !== n && n.dom.container.trigger("dtsb-redrawContents-noDraw"),
            0 === n.s.criteria.length && s("." + s.fn.dataTable.Group.classes.add.replace(/ /g, ".")).click()
        },
        config: {},
        init: function(e, n, t) {
            var i = new f.SearchBuilder(e,s.extend({
    ...
    i("searchBuilder.rebuild()", function(t) {
        var i = this.context[0];
        return void 0 === i._searchBuilder ? null : (i._searchBuilder.rebuild(t),
        this)
    }),
    ...
    s(t).on("preInit.dt.dtsp", function(t, i) {
        "dt" !== t.namespace || !i.oInit.searchBuilder && !f.defaults.searchBuilder || i._searchBuilder || v(i)
    }),
    f.ext.feature.push({
        cFeature: "Q",
        fnInit: v
    }),
    f.feature && f.feature.register("searchBuilder", v),
    f
});
...
!function(n) {
    var d, a;
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-dt", "datatables.net-searchbuilder"], function(e) {
        return n(e, window, document)
    }) : "object" == typeof exports ? (d = require("jquery"),
    a = function(e, t) {
        t.fn.dataTable || require("datatables.net-dt")(e, t),
...
!function(l) {
    ...
    }) : "object" == typeof exports ? (s = require("jquery"),
    c = function(e, t) {
        t.fn.dataTable || require("datatables.net")(e, t)
    }
    ,
    ...
    : (c(window, s),
    module.exports = l(s, window, window.document))) : l(jQuery, window, document)
}(function(m, i, e) {
    "use strict";
    ...
    function r(n, e, t) {
        ...
        function s(t, l) {
            var e, s = n.rows({
                search: "applied"
            }).indexes(), c = (s.indexOf(t) > s.indexOf(l) && (e = l,
            l = t,
            t = e),
            !1);
        ...
        var c, t = n.cells({
            selected: !0
        }).any() || t ? (c = l(t.column, e.column),
        s(t.row, e.row)) : (c = l(0, e.column),
        s(0, e.row)), t = n.cells(t, c).flatten();
        n.cells(e, {
            selected: !0
    ...
    function n(o) {
        var a, t = m(o.table().container()), l = o.settings()[0], s = l._select.selector;
        t.on("mousedown.dtSelect", s, function(e) {
            ...
            var t, l = o.select.items();
            if (a) {
                var s = i.getSelection();
                if ((!s.anchorNode || m(s.anchorNode).closest("table")[0] === o.table().node()) && s !== a)
                    return
            }
            var c, s = o.settings()[0], n = o.table().container();
            m(e.target).closest("div.dt-container")[0] == n && (n = o.cell(m(e.target).closest("td, th"))).any() && (c = m.Event("user-select.dt"),
            d(o, c, [l, n, e]),
            c.isDefaultPrevented() || (c = n.index(),
            "row" === l ? (t = c.row,
            h(e, o, s, "row", t)) : "column" === l ? (t = n.index().column,
            h(e, o, s, "column", t)) : "cell" === l && (t = n.index(),
            h(e, o, s, "cell", t)),
            s._select_lastCell = c))
        }),
        m("body").on("click.dtSelect" + v(o.table().node()), function(e) {
            var t;
            !l._select.blurable || m(e.target).parents().filter(o.table().container()).length || 0 === m(e.target).parents("html").length || m(e.target).parents("div.DTE").length || (t = m.Event("select-blur.dt"),
            d(o, t, [e.target, e]),
            t.isDefaultPrevented()) || f(l, !0)
        })
    }
    function d(e, t, l, s) {
        s && !e.flatten().length || ("string" == typeof t && (t += ".dt"),
        l.unshift(e),
        m(e.table().node()).trigger(t, l))
    }
    function a(s, e) {
        var t, l, c, n, o;
        "api" !== s.select.style() && !1 !== s.select.info() && (o = s.rows({
            selected: !0
        }).flatten().length,
        t = s.columns({
            selected: !0
    ...
    function p(o) {
        o.columns(".dt-select").every(function() {
            var n, e = this.header();
            m("input", e).length || (n = m("<input>").attr({
                class: "dt-select-checkbox",
                type: "checkbox",
                "aria-label": o.i18n("select.aria.headerCheckbox") || "Select all rows"
            ...
            o.on("draw select deselect", function(e, t, l) {
                ...
                s && s <= l && s === c ? n.prop("checked", !0).prop("indeterminate", !1) : 0 === s && 0 === l ? n.prop("checked", !1).prop("indeterminate", !1) : n.prop("checked", !1).prop("indeterminate", !0))
            }))
        })
    }
    function u(e, t, l, s) {
        var c, n = e[t + "s"]({
            search: "applied"
        }).indexes(), s = n.indexOf(s), o = n.indexOf(l);
        e[t + "s"]({
            selected: !0
        }).any() || -1 !== s ? (o < s && (c = o,
        o = s,
        ...
        n.splice(0, s)) : n.splice(n.indexOf(l) + 1, n.length),
        e[t](l, {
            selected: !0
        }).any() ? (n.splice(n.indexOf(l), 1),
        e[t + "s"](n).deselect()) : e[t + "s"](n).select()
    }
    function f(e, t) {
    ...
    function h(e, t, l, s, c) {
        ...
        a && !o || ("os" === n ? e.ctrlKey || e.metaKey ? t[s](c).select(!a) : e.shiftKey ? "cell" === s ? r(t, c, l._select_lastCell || null) : u(t, s, c, l._select_lastCell ? l._select_lastCell[s] : null) : (o = t[s + "s"]({
            selected: !0
        }),
        a && 1 === o.flatten().length ? t[s](c).deselect() : (o.deselect(),
    ...
    _.select.init = function(c) {
        var e, t, l, s, n, o, a, i, r, d, u, f, h = c.settings()[0];
        if (!_.versionCheck("2"))
            throw "Warning: Select requires DataTables 2 or newer";
        h._select || (e = c.state.loaded(),
        t = function(e, t, l) {
            if (null !== l && void 0 !== l.select) {
                ...
                c.columns({
                    selected: !0
                }).any() && c.columns().deselect(),
                void 0 !== l.select.columns && c.columns(l.select.columns).select(),
                c.cells({
                    selected: !0
                }).any() && c.cells().deselect(),
        ...
        !0 === l ? (n = "os",
        f = !0) : "string" == typeof l ? (n = l,
        f = !0) : m.isPlainObject(l) && (void 0 !== l.blurable && (o = l.blurable),
        void 0 !== l.toggleable && (a = l.toggleable),
        void 0 !== l.info && (i = l.info),
        void 0 !== l.items && (s = l.items),
        f = (n = void 0 !== l.style ? l.style : "os",
        !0),
        void 0 !== l.selector && (r = l.selector),
        void 0 !== l.className && (d = l.className),
        void 0 !== l.headerCheckbox) && (u = l.headerCheckbox),
        c.select.selector(r),
        c.select.items(s),
        c.select.style(n),
        c.select.blurable(o),
        ...
        !f && m(c.table().node()).hasClass("selectable") && c.select.style("os"),
        u && (p(c),
        c.on("init", function() {
            p(c)
        })))
    ...
    m.each([{
        ...
        _.ext.selector[i.type].push(function(e, t, l) {
            var s, c = t.selected, n = [];
            if (!0 !== c && !1 !== c)
                return l;
            for (var o = 0, a = l.length; o < a; o++)
                (s = e[i.prop][l[o]]) && (!0 === c && !0 === s._select_selected || !1 === c && !s._select_selected) && n.push(l[o]);
            return n
        })
    }),
    _.ext.selector.cell.push(function(e, t, l) {
        ...
        if (void 0 === c)
            return l;
        for (var o = 0, a = l.length; o < a; o++)
            (s = e.aoData[l[o].row]) && (!0 === c && s._selected_cells && !0 === s._selected_cells[l[o].column] || !1 === c && (!s._selected_cells || !s._selected_cells[l[o].column])) && n.push(l[o]);
        return n
    });
    ...
    t("select.blurable()", function(t) {
        return void 0 === t ? this.context[0]._select.blurable : this.iterator("table", function(e) {
            e._select.blurable = t
        })
    }),
    t("select.toggleable()", function(t) {
        return void 0 === t ? this.context[0]._select.toggleable : this.iterator("table", function(e) {
            e._select.toggleable = t
        })
    }),
    t("select.info()", function(t) {
        return void 0 === t ? this.context[0]._select.info : this.iterator("table", function(e) {
            e._select.info = t
        })
    }),
    t("select.items()", function(t) {
        return void 0 === t ? this.context[0]._select.items : this.iterator("table", function(e) {
            e._select.items = t,
            d(new _.Api(e), "selectItems", [t])
        })
    }),
    t("select.style()", function(l) {
        return void 0 === l ? this.context[0]._select.style : this.iterator("table", function(e) {
            e._select || _.select.init(new _.Api(e)),
            e._select_init || (o = e,
            c = new _.Api(o),
            o._select_init = !0,
            o.aoRowCreatedCallback.push(function(e, t, l) {
                var s, c, n = o.aoData[l];
                for (n._select_selected && m(e).addClass(o._select.className),
                s = 0,
                c = o.aoColumns.length; s < c; s++)
            ...
            c.on("destroy.dtSelect", function() {
                m(c.rows({
                    selected: !0
                }).nodes()).removeClass(c.settings()[0]._select.className),
                s(c),
                c.off(".dtSelect"),
                m("body").off(".dtSelect" + v(c.table().node()))
            })),
            e._select.style = l;
            var o, c, t = new _.Api(e);
            s(t),
            "api" !== l && n(t),
            d(new _.Api(e), "selectStyle", [l])
        })
    }),
    t("select.selector()", function(t) {
        return void 0 === t ? this.context[0]._select.selector : this.iterator("table", function(e) {
            s(new _.Api(e)),
    ...
    t("select.last()", function(e) {
        var t = this.context[0];
        return e ? (t._select_lastCell = e,
        this) : t._select_lastCell
    }),
    l("rows().select()", "row().select()", function(e) {
        ...
        return !1 === e ? this.deselect() : (this.iterator("row", function(e, t) {
            ...
            for (var c = 0; c < s.length; c++)
                "select-checkbox" === s[c].sType && (m("input.dt-select-checkbox", l.anCells[c]).prop("checked", !0),
                l._aSortData[c] = null)
        }),
    ...
    l("rows().deselect()", "row().deselect()", function() {
        ...
        return this.iterator("row", function(e, t) {
            ...
            for (var c = 0; c < s.length; c++)
                "select-checkbox" === s[c].sType && (m("input.dt-select-checkbox", l.anCells[c]).prop("checked", !1),
                l._aSortData[c] = null)
        }),
        this.iterator("table", function(e, t) {
    ...
    return m.extend(_.ext.buttons, {
        selected: {
            ...
            init: function(l, e, s) {
                ...
                l.on(w(s), function() {
                    var e, t;
                    c.enable((e = l,
                    !(-1 === (t = s).limitTo.indexOf("rows") || !e.rows({
                        selected: !0
                    }).any()) || !(-1 === t.limitTo.indexOf("columns") || !e.columns({
                        selected: !0
                    }).any()) || !(-1 === t.limitTo.indexOf("cells") || !e.cells({
                        selected: !0
                    }).any())))
                }),
                this.disable()
        ...
        selectAll: {
            ...
            action: function(e, t, l, s) {
                ...
                (n ? ("function" == typeof n && (n = n.call(t, e, t, l, s)),
                this[c + "s"](n)) : this[c + "s"]()).select()
            }
        },
        selectNone: {
        ...
        showSelected: {
            ...
            action: function(e, t) {
                var s;
                t.search.fixed("dt-select") ? (t.search.fixed("dt-select", null),
                this.active(!1)) : (s = t.settings()[0].aoData,
    ...
    _.render.select = function(e, t) {
        ...
        return function(e, t, l, s) {
            ...
            return "display" === t ? m("<input>").attr({
                ...
                value: n ? n(l) : null,
                checked: c
            })[0] : "type" === t ? "select-checkbox" : "filter" !== t && c ? "X" : ""
        }
    }
    ,
...
!function(n) {
    var d, o;
    "function" == typeof define && define.amd ? define(["jquery", "datatables.net-dt", "datatables.net-select"], function(e) {
        return n(e, window, document)
    }) : "object" == typeof exports ? (d = require("jquery"),
    o = function(e, t) {
        t.fn.dataTable || require("datatables.net-dt")(e, t),
